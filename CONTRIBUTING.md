...
1. Request a `workspace/${workspace}` branch by asking one of the [repository maintainers](https://github.com/orgs/redhat-developer/teams/rhdh-cope).
   ...
   <details>
   <summary>Repository maintainers – Branch protection settings</summary>
