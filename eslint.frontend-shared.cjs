...
const muiV5StylesMessage =
  'Use @mui/material (sx/styled) or Backstage UI (@backstage/ui) instead. @mui/styles is deprecated (legacy JSS) and is not compatible with React 18 / StrictMode.';
...
const materialUiMigrationEslintConfig = {
  restrictedImports: [
    ...
    },
    {
      ...
      message:
        'Use @mui/x-date-pickers instead of Material UI v4 date pickers.',
    },
    {
      name: '@mui/styles',
      message: muiV5StylesMessage,
