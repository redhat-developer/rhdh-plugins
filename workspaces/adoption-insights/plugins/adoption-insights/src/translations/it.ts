...
const adoptionInsightsTranslationIt = createTranslationMessages({
  ...
  messages: {
    ...
    'notifications.title': 'Notifiche tempo risparmiato',
    'notifications.description':
      'Scegli con che frequenza ricevere un riepilogo del tempo risparmiato utilizzando i modelli software.',
    'notifications.frequencyLabel': 'Frequenza notifiche',
    'notifications.daily': 'Giornaliero',
    'notifications.weekly': 'Settimanale',
    'notifications.monthly': 'Mensile',
    'notifications.none': 'Nessuna notifica',
