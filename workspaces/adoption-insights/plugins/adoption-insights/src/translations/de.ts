...
const adoptionInsightsTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    'searches.week': 'Woche',
    'timeSavedBadge.estTimeSaved': 'Gesch. Zeitersparnis: {{duration}}',
    'timeSavedBadge.addEstTimeSaved': 'Gesch. Zeitersparnis hinzufügen',
    'timeSavedBadge.presentTooltip':
      'Diese Zahl zeigt die typische Zeit, die für diese Arbeit ohne die Vorlage benötigt wird, wie vom Eigentümer angegeben.',
    'timeSavedBadge.absentTooltipInstruction':
      'Helfen Sie den Nutzern, den Wert Ihrer Vorlage zu erkennen.\nFügen Sie diese Annotation zu Ihrer template.yaml hinzu:',
    'timeSavedBadge.annotationSnippet': "rhdh.redhat.com/time-saved: '<Dauer>'",
    'timeSavedBadge.copied': 'Kopiert!',
    'timeSavedBadge.copyAnnotation': 'Annotation kopieren',
