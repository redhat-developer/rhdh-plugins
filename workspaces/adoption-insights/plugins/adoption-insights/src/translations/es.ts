...
const adoptionInsightsTranslationEs = createTranslationMessages({
  ...
  messages: {
    ...
    'notifications.title': 'Notificaciones de tiempo ahorrado',
    'notifications.description':
      'Elija con qué frecuencia recibir un resumen del tiempo ahorrado usando plantillas de software.',
    'notifications.frequencyLabel': 'Frecuencia de notificaciones',
