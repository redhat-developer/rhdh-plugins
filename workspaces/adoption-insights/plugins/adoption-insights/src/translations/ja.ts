...
const adoptionInsightsTranslationJa = createTranslationMessages({
  ...
  messages: {
    ...
    'searches.week': '週',
    'notifications.title': '節約時間の通知',
    'notifications.description':
      'ソフトウェアテンプレートを使用して節約した時間のサマリーを受け取る頻度を選択してください。',
    'notifications.frequencyLabel': '通知頻度',
    'notifications.daily': '毎日',
    'notifications.weekly': '毎週',
    'notifications.monthly': '毎月',
    'notifications.none': '通知なし',
