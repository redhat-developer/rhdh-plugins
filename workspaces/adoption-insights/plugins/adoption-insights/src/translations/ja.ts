...
const adoptionInsightsTranslationJa = createTranslationMessages({
  ...
  messages: {
    ...
    'searches.week': '週',
    'timeSavedBadge.estTimeSaved': '推定節約時間: {{duration}}',
    'timeSavedBadge.addEstTimeSaved': '推定節約時間を追加',
    'timeSavedBadge.presentTooltip':
      'この数字は、テンプレートを使用せずにこの作業を行う場合の一般的な時間を反映しています（オーナーによる報告）。',
    'timeSavedBadge.absentTooltipInstruction':
      'テンプレートの価値をユーザーに示しましょう。\ntemplate.yaml に次のアノテーションを追加してください:',
    'timeSavedBadge.annotationSnippet': "rhdh.redhat.com/time-saved: '<期間>'",
    'timeSavedBadge.copied': 'コピーしました！',
    'timeSavedBadge.copyAnnotation': 'アノテーションをコピー',
