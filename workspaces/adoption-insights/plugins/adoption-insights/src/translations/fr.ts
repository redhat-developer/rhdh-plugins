...
const adoptionInsightsTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'timeSavedBadge.estTimeSaved': 'Temps est. économisé : {{duration}}',
    'timeSavedBadge.addEstTimeSaved': 'Ajouter le temps est. économisé',
    'timeSavedBadge.presentTooltip':
      'Ce nombre reflète le temps typique pour effectuer ce travail sans le modèle, tel que rapporté par le propriétaire.',
    'timeSavedBadge.absentTooltipInstruction':
      'Aidez les utilisateurs à voir la valeur de votre modèle.\nAjoutez cette annotation à votre template.yaml :',
    'timeSavedBadge.annotationSnippet': "rhdh.redhat.com/time-saved: '<durée>'",
    'timeSavedBadge.copied': 'Copié !',
    'timeSavedBadge.copyAnnotation': "Copier l'annotation",
