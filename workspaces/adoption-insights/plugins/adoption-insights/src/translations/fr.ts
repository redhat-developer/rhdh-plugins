...
const adoptionInsightsTranslationFr = createTranslationMessages({
  ...
  messages: {
    'activeUsers.averagePrefix': 'Une moyenne de',
    'activeUsers.averageSuffix': 'étaient actifs durant cette période.',
    ...
    'searches.averagePrefix': 'Une moyenne de',
    'searches.averageSuffix': 'ont été menées au cours de cette période.',
