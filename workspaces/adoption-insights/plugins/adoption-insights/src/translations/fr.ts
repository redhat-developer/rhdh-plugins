...
const adoptionInsightsTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'notifications.title': 'Notifications de temps économisé',
    'notifications.description':
      'Choisissez la fréquence à laquelle vous recevez un résumé du temps économisé grâce aux modèles logiciels.',
    'notifications.frequencyLabel': 'Fréquence des notifications',
