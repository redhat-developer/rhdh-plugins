      ...
      >
        ...
        <MenuItem>
          <Link
            underline="none"
            to="/create"
            style={{ display: 'inline-block', fontSize: '0.875em' }}
          >
            All templates
          </Link>
        </MenuItem>
          ...
          <Menu slots={{ listbox: Listbox }}>
            <MenuSection label="Use a template">
              {models.map(m => (
                ...
                >
                  <Link
                    to={`/create/templates/default/${m.value}`}
                    underline="none"
                  >
                    <Typography
                      variant="body2"
          ...
          <Dropdown>
            <MenuButton slots={{ root: 'div' }}>
              ...
              >
                ...
                <Typography
                  variant="body2"
                  sx={{ fontWeight: '500 !important', margin: '0 0.5rem' }}
                >
                  John Smith
                </Typography>
