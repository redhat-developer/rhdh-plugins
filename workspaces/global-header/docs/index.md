...
The plugin uses the **New Frontend System (stable)**. Import from the package root
...
The Old Frontend System `/legacy` export and Scalprum mount-point integration have been removed.
