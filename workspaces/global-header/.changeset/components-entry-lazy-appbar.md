...
`globalHeaderModule` registers system icon ids (`article`, `bug_report`, `quiz`, `forum`, `dashboard`, etc.) via `IconBundleBlueprint` as outlined MUI SVGs for config and default extensions.
