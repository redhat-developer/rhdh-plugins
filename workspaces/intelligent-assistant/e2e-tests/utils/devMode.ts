...
const notebookLightspeedV1RouteMatches = (url: URL): boolean =>
  url.pathname.includes('/api/intelligent-assistant/notebooks/v1/');
...
/**
 * Stateful handler for `/api/intelligent-assistant/notebooks/v1/**` (sessions + documents).
...
/**
 * Mocks GET/PATCH `/api/intelligent-assistant/mcp-servers` and POST credential/server validation.
