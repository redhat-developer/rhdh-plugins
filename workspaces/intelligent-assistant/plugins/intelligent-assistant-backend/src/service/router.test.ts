...
describe('intelligent-assistant router tests', () => {
  ...
  describe('GET /health', () => {
    it('returns ok', async () => {
      ...
      const response = await request(backendServer).get(
        '/api/intelligent-assistant/health',
      );
  ...
  describe('GET /v1/shields', () => {
    it('should load available shields without injecting user_id', async () => {
      ...
      const backendServer = await startBackendServer();
      const response = await request(backendServer).get(
        '/api/intelligent-assistant/v1/shields',
      );
  ...
  describe('GET /v2/conversations', () => {
    it('load conversations list with summary', async () => {
      ...
      const backendServer = await startBackendServer();
      const response = await request(backendServer).get(
        `/api/intelligent-assistant/v2/conversations`,
      );
      expect(response.statusCode).toEqual(200);
      // Parse response body
      const responseData = response.body;
  ...
  describe('PUT /v2/conversations/:conversation_id', () => {
    it('should successfully update topic summary', async () => {
      ...
      const response = await request(backendServer)
        .put(
          `/api/intelligent-assistant/v2/conversations/${encodedConversationId}`,
        )
        .send({
    ...
    it('should return upstream status code when conversation does not exist', async () => {
      ...
      const response = await request(backendServer)
        .put(
          `/api/intelligent-assistant/v2/conversations/${mockAnotherConversationId}`,
        )
        .send({
          topic_summary: 'new topic',
        });
  ...
  describe('POST /v1/feedback', () => {
    ...
    it('should send the feedback successfully', async () => {
      ...
      const response = await request(backendServer)
        .post('/api/intelligent-assistant/v1/feedback')
        .send({
  ...
  describe('GET /v1/feedback/status', () => {
    ...
    it('should send the feedback successfully', async () => {
      ...
      const response = await request(backendServer).get(
        '/api/intelligent-assistant/v1/feedback/status',
      );
  ...
  describe('unregistered paths', () => {
    it('should return 404 for unregistered path /v1/admin', async () => {
      const backendServer = await startBackendServer();
      const response = await request(backendServer).get(
        '/api/intelligent-assistant/v1/admin',
      );
      expect(response.statusCode).toEqual(404);
      expect(response.body).toEqual({
    ...
    it('should return 404 for unregistered path /internal/config', async () => {
      const backendServer = await startBackendServer();
      const response = await request(backendServer).get(
        '/api/intelligent-assistant/internal/config',
      );
      expect(response.statusCode).toEqual(404);
      expect(response.body).toEqual({
        error: 'Requested path is not available',
    ...
    it('should return 404 for POST to arbitrary path', async () => {
      const backendServer = await startBackendServer();
      const response = await request(backendServer)
        .post('/api/intelligent-assistant/some/arbitrary/path')
        .send({});
      expect(response.statusCode).toEqual(404);
      expect(response.body).toEqual({
        error: 'Requested path is not available',
    ...
    it.each([
      '/api/intelligent-assistant/v1/models-secret',
      '/api/intelligent-assistant/v1/shieldsadmin',
      '/api/intelligent-assistant/v2/conversationsextra',
      '/api/intelligent-assistant/v1/feedbackextra',
    ...
    it('should reject dot-segment path traversal attempts', async () => {
      const backendServer = await startBackendServer();
      const response = await request(backendServer).get(
        '/api/intelligent-assistant/v1/models/../admin',
      );
      expect(response.statusCode).toEqual(404);
      expect(response.body).toEqual({
        error: 'Requested path is not available',
  ...
  describe('POST /v1/query/interrupt', () => {
    it('returns success when interrupt succeeds', async () => {
      ...
      const response = await request(backendServer)
        .post('/api/intelligent-assistant/v1/query/interrupt')
