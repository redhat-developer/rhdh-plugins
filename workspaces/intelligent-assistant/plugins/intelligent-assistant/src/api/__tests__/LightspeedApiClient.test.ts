...
describe('LightspeedApiClient', () => {
  ...
  describe('getBaseUrl', () => {
    it('should return the correct base URL', async () => {
      ...
      expect(baseUrl).toBe('http://localhost:7007/api/intelligent-assistant');
  ...
  describe('getAllModels', () => {
    it('should return models when API call succeeds', async () => {
      ...
      expect(mockFetchApi.fetch).toHaveBeenCalledWith(
        'http://localhost:7007/api/intelligent-assistant/v1/models',
  ...
  describe('getConversations', () => {
    it('should return conversations when API call succeeds', async () => {
      ...
      expect(mockFetchApi.fetch).toHaveBeenCalledWith(
        'http://localhost:7007/api/intelligent-assistant/v2/conversations',
        expect.any(Object),
      );
    });
  ...
  describe('getConversationMessages', () => {
    ...
    it('should return messages when API call succeeds', async () => {
      ...
      expect(mockFetchApi.fetch).toHaveBeenCalledWith(
        'http://localhost:7007/api/intelligent-assistant/v2/conversations/conv-123',
        expect.any(Object),
      );
    });
  ...
  describe('getFeedbackStatus', () => {
    it('should return true when feedback is enabled', async () => {
      ...
      expect(mockFetchApi.fetch).toHaveBeenCalledWith(
        'http://localhost:7007/api/intelligent-assistant/v1/feedback/status',
  ...
  describe('captureFeedback', () => {
    it('should return response when feedback is captured', async () => {
      ...
      expect(mockFetchApi.fetch).toHaveBeenCalledWith(
        'http://localhost:7007/api/intelligent-assistant/v1/feedback',
        expect.objectContaining({
          method: 'POST',
  ...
  describe('stopMessage', () => {
    it('should return success when stop succeeds', async () => {
      ...
      expect(result).toEqual({ success: true });
      expect(mockFetchApi.fetch).toHaveBeenCalledWith(
        'http://localhost:7007/api/intelligent-assistant/v1/query/interrupt',
        expect.objectContaining({
          method: 'POST',
  ...
  describe('createMessage', () => {
    it('should return readable stream reader when message is created', async () => {
      ...
      expect(mockFetchApi.fetch).toHaveBeenCalledWith(
        'http://localhost:7007/api/intelligent-assistant/v1/query',
        expect.objectContaining({
          method: 'POST',
          body: JSON.stringify({
            conversation_id: 'conv-123',
