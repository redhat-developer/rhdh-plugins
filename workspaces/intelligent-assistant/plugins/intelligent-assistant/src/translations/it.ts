...
const intelligentAssistantTranslationIt = createTranslationMessages({
  ...
  messages: {
    ...
    'chatbox.emptyState.noPinnedChats':
      'Fissa le chat in alto per mantenerle in primo piano',
    'chatbox.emptyState.noRecentChats': 'Nessuna chat recente',
    'chatbox.emptyState.noResults.body':
      "Modifica la query di ricerca e riprova. Controlla l'ortografia o prova con un termine più generico.",
    ...
    'conversation.announcement.userMessage':
      "Messaggio dall'Utente: {{prompt}}. Messaggio dal bot in caricamento.",
    ...
    'conversation.delete.confirm.message':
      'Non vedrai più questa chat qui. In questo modo verranno eliminate anche le attività correlate, come prompt, risposte e feedback, dalla tua attività.',
    ...
    disclaimer:
      'Questa funzionalità utilizza la tecnologia IA. Non includere informazioni personali o altre informazioni sensibili nel tuo input. Le interazioni possono essere utilizzate per migliorare i prodotti o i servizi di Red Hat.',
    ...
    'feedback.form.textAreaPlaceholder':
      'Fornisci commenti aggiuntivi (opzionale)',
    ...
    'file.upload.error.fileTooLarge':
      'La dimensione del file è eccessiva. Assicurati che il tuo file sia inferiore a 25 MB.',
    ...
    'lcore.notConfigured.backendDocs':
      "Configurazione del backend dell'assistente intelligente",
    'lcore.notConfigured.description':
      "L'assistente intelligente richiede un LLM registrato. Contatta l'amministratore della piattaforma della tua organizzazione per completare la configurazione.",
    'lcore.notConfigured.developerLightspeedDocs':
      "Configurazione dell'assistente intelligente di Developer Hub",
    ...
    'mcp.settings.configureServerTitle':
      'Impostazioni del server MCP {{serverName}}',
    ...
    'mcp.settings.modalDescription':
      'Le credenziali sono crittografate e le operazioni utilizzano le tue autorizzazioni esatte.',
    ...
    'mcp.settings.modal.tokenRemovedWarning':
      'Il token è stato rimosso. Per utilizzare nuovamente questo server MCP, è necessario fornire un nuovo token.',
    ...
    'mcp.settings.modal.enabledDescription':
      'Questo server è attivo e disponibile in chat.',
    'mcp.settings.modal.enabledDescriptionOff':
      'Questo server è disabilitato e non disponibile in chat.',
    'mcp.settings.modal.enabledDescriptionTokenRequired':
      "Questo server è attualmente disabilitato. Fornisci un token per l'abilitazione.",
    ...
    'mcp.settings.token.invalidCredentials':
      "Credenziali non valide. Verifica l'URL del server e il token.",
    'mcp.settings.token.savingAndValidating':
      'Salvataggio e convalida del token...',
    ...
    'mcp.settings.token.validationFailed':
      "Validazione non riuscita. Verifica l'URL del server e il token.",
    ...
    'notebook.document.delete.description':
      "Rimuovere<documentName/> da questo notebook? L'azione non può essere annullata.",
    'notebook.document.delete.success':
      '"{{documentName}}" rimosso correttamente.',
    ...
    'notebook.overwrite.modal.description':
      '{{duplicateCount}} file sono già presenti in questo notebook. {{newCount}} nuove risorse verranno aggiunte comunque.',
    ...
    'notebook.overwrite.modal.description.one':
      '{{duplicateCount}} file è già presente in questo notebook. {{newCount}} nuove risorse verranno aggiunte comunque.',
    ...
    'notebook.upload.error.tooManyFiles':
      'Errore di caricamento: è consentito un numero massimo di {{max}} file.',
    'notebook.upload.error.unsupportedType':
      'Errore di caricamento: rilevati tipi di file non supportati. Carica solo tipi di file supportati.',
    ...
    'notebook.upload.modal.dragDropTitle':
      'Trascina e rilascia i file qui oppure fai clic per sfogliare',
    ...
    'notebook.view.documents.maxReached':
      'È consentito un massimo di 10 risorse. Elimina una risorsa per caricarne una nuova.',
    'notebook.view.documents.uploading': 'Caricamento della risorsa',
    'notebook.view.documents.uploadsInProgress':
      'Attendi il completamento dei caricamenti in corso prima di aggiungere altre risorse.',
    ...
    'notebook.view.processing.heading':
      'Elaborazione delle risorse in corso...',
    ...
    'notebooks.delete.message':
      'Non troverai più questo notebook qui. In questo modo verranno eliminate anche le attività correlate, come prompt, risposte e feedback, dalla tua attività.',
    ...
    'notebooks.empty.description':
      "Crea un nuovo notebook per organizzare le tue fonti e generare insights basati sull'IA.",
    'notebooks.empty.title': 'Nessun notebook creato',
    'notebooks.prompts.accessIssue.title':
      'Aiutami a risolvere un problema di accesso',
    ...
    'prompts.codeOptimization.message':
      'Puoi suggerire dei metodi comuni per ottimizzare il codice e ottenere prestazioni migliori?',
    'prompts.codeOptimization.title': 'Suggerisci ottimizzazioni al codice',
    'prompts.codeReadability.message':
      'Potresti suggerirmi delle tecniche per rendere il mio codice più leggibile e manutenibile?',
    'prompts.codeReadability.title':
      'Ottieni assistenza sulla leggibilità del codice',
    ...
    'prompts.developmentConcept.message':
      "Puoi spiegare come funziona un'architettura a microservizi e quali sono i suoi vantaggi rispetto a un'architettura monolitica?",
    'prompts.developmentConcept.title': 'Spiega un concetto di sviluppo',
    'prompts.documentation.message':
      "Puoi riassumere la documentazione per l'implementazione dell'autenticazione OAuth 2.0 in un'applicazione web?",
    'prompts.documentation.title': 'Riepilogo della documentazione',
    'prompts.eventDriven.message':
      "Puoi spiegare cos'è l'architettura basata sugli eventi e quando è vantaggioso utilizzarla nello sviluppo software?",
    'prompts.eventDriven.title':
      "Comprendere l'architettura basata sugli eventi",
    'prompts.gitWorkflows.message':
      'Vorrei apportare modifiche al codice su un altro ramo senza perdere il lavoro già svolto. Qual è la procedura per farlo usando Git?',
    'prompts.gitWorkflows.title': 'Flussi di lavoro con Git',
    'prompts.openshift.message':
      "Puoi guidarmi nella creazione di un nuovo deployment su OpenShift per un'applicazione containerizzata?",
    'prompts.openshift.title': 'Creare un deployment su OpenShift',
    'prompts.rhdh.message':
      'Puoi spiegarmi come iniziare a usare Developer Hub come sviluppatore, ad esempio esplorando il catalogo software e aggiungendo il mio servizio?',
    'prompts.rhdh.title': 'Guida introduttiva a Red Hat Developer Hub',
    'prompts.sortingAlgorithms.message':
      "Puoi spiegare la differenza tra un algoritmo di ordinamento rapido (quicksort) e un algoritmo di ordinamento per fusione (merge sort), e quando utilizzare l'uno o l'altro?",
    'prompts.sortingAlgorithms.title':
      'Sfatare i miti sugli algoritmi di ordinamento',
    'prompts.tekton.message':
      'Puoi aiutarmi ad automatizzare il deployment della mia applicazione utilizzando Tekton Pipelines?',
    'prompts.tekton.title': 'Deployment con Tekton',
    'prompts.testingStrategies.message':
      'Puoi consigliarmi alcune strategie di test comuni che renderanno la mia applicazione robusta e priva di errori?',
    ...
    'settings.pinned.disabled.description':
      'Le chat fissate sono attualmente disabilitate',
    'settings.pinned.enable': 'Abilita le chat fissate',
    'settings.pinned.enabled.description':
      'Le chat fissate sono attualmente abilitate',
    ...
    'sources.modal.description':
      "Per generare questa risposta dell'IA e fornire le informazioni di supporto, sono state utilizzate le seguenti fonti:",
