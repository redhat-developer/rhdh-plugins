...
const intelligentAssistantTranslationEs = createTranslationMessages({
  ...
  messages: {
    ...
    'notebook.document.rename.tooltip': 'Clic para renombrar',
    ...
    'notebook.overwrite.modal.action': 'Subir ({{count}})',
    ...
    'notebooks.rename.inline.tooltip': 'Clic para renombrar',
    'notebooks.rename.inline.error': 'Error al renombrar "{{notebookName}}".',
    ...
    'savedPrompts.count.zero': 'No hay prompts guardados',
