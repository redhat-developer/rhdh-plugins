...
export const intelligentAssistantTranslationRef: TranslationRef<
  'plugin.intelligent-assistant',
  {
    ...
    readonly 'notebook.upload.modal.supportedFormats': string;
    readonly 'notebook.upload.modal.maxFileSize': string;
    readonly 'notebook.upload.modal.selectedFiles': string;
    readonly 'notebook.upload.modal.addButton': string;
    readonly 'notebook.upload.modal.addButtonEmpty': string;
    ...
    readonly 'notebook.overwrite.modal.back': string;
    ...
    readonly 'settings.savedPrompts.enable': string;
    ...
    readonly 'savedPrompts.tab.title': string;
    readonly 'savedPrompts.disabled.title': string;
    readonly 'savedPrompts.disabled.body': string;
    readonly 'savedPrompts.disabled.enableLink': string;
    readonly 'savedPrompts.count.zero': string;
    readonly 'savedPrompts.count_one': string;
    ...
    readonly 'savedPrompts.validation.contentMaxLength': string;
    readonly 'savedPrompts.limitReached': string;
    readonly 'savedPrompts.actions.apply': string;
    readonly 'savedPrompts.actions.send': string;
    readonly 'savedPrompts.actions.sendDisabledStreaming': string;
    readonly 'savedPrompts.actions.delete': string;
    readonly 'savedPrompts.actions.menuAriaLabel': string;
    readonly 'savedPrompts.delete.confirm.title': string;
    readonly 'savedPrompts.delete.confirm.message': string;
    readonly 'savedPrompts.delete.confirm.action': string;
    readonly 'savedPrompts.empty.description': string;
    readonly 'savedPrompts.sidebar.showAll': string;
    readonly 'savedPrompts.sidebar.showLess': string;
    readonly 'savedPrompts.sidebar.openSettings': string;
    readonly 'savedPrompts.sidebar.empty': string;
  }
>;

// @alpha
export const lightspeedTranslations: TranslationResource<'plugin.intelligent-assistant'>;
