...
const materialUiMigrationEslintConfig = {
  restrictedImports: [
    ...
    },
    {
      ...
      message:
        'Use tss-react/mui, @mui/material (sx/styled), or Backstage UI instead of Material UI v4.',
    },
    {
      name: '@mui/styles',
      message:
        'Use tss-react/mui makeStyles or @mui/material (sx/styled) instead of deprecated @mui/styles.',
    },
  ],
