...
import type { AdversarialAgentSnapshot } from '@red-hat-developer-hub/backstage-plugin-x2a-common';
...
// @public
export function calculateModuleStatus(input: {
  analyze?: Job;
  migrate?: Job;
  publish?: Job;
}): {
...
// @public
export function listModulesWithReconciledStatuses(
  modules: Module[],
...
// @public
export function reconcileModuleJobs(
  module: Module,
  deps: ReconcileJobDeps,
): Promise<Module>;
...
export interface X2ADatabaseServiceApi {
  ...
  // (undocumented)
  getJobWithLog(args: { id: string }): Promise<
    | (Job & {
        log?: string | null;
      })
    | undefined
