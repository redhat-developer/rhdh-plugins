...
const lightspeedTranslationIt = createTranslationMessages({
  ...
  messages: {
    ...
    'lcore.loadError.description': 'Il backend Lightspeed non ha restituito un elenco di modelli. Verifica che il servizio sia in esecuzione e raggiungibile, quindi riprova.',
    'lcore.loadError.title': 'Impossibile caricare i modelli',
    'lcore.notConfigured.backendDocs': 'Configurazione backend Lightspeed',
    'lcore.notConfigured.description': 'Lightspeed richiede un LLM registrato. Contattare l\'amministratore della piattaforma dell\'organizzazione per completare la configurazione.',
    'lcore.notConfigured.developerLightspeedDocs': 'Configurazione di Developer Lightspeed',
    ...
    'mcp.settings.modalDescription': 'Le credenziali sono crittografate a riposo e associate al tuo profilo. Lightspeed opererà con esattamente le tue autorizzazioni.',
    ...
    'mcp.settings.token.urlUnavailableForValidation': 'Impossibile convalidare il token perché l\'URL del server non è disponibile.',
    ...
    'notebook.document.delete.description': 'Sei sicuro di voler rimuovere <documentName/> da questo quaderno? Questa azione non può essere annullata.',
    'notebook.document.delete.success': '«{{documentName}}» rimosso con successo.',
    'notebook.document.delete.title': 'Rimuovere la risorsa?',
    'notebook.overwrite.modal.action': 'Sovrascrivi',
    'notebook.overwrite.modal.description': 'I seguenti file esistono già in questo quaderno. Vuoi sovrascriverli con le nuove versioni?',
    'notebook.overwrite.modal.title': 'Sovrascrivere i file?',
    'notebook.upload.error.fileTooLarge': 'Errore di caricamento: la dimensione del file supera il limite di 25 MB.',
    'notebook.upload.error.tooManyFiles': 'Errore di caricamento: sono consentiti al massimo {{max}} file.',
    'notebook.upload.error.unsupportedType': 'Errore di caricamento: trovati tipi di file non supportati. Caricare solo tipi di file supportati.',
    ...
    'notebook.upload.modal.infoText': 'Tipi di file accettati: .md, .txt, .pdf, .json, .yaml, .log',
    ...
    'notebook.view.documents.maxReached': 'Sono consentiti al massimo 10 documenti. Elimina un documento per caricarne uno nuovo.',
    'notebook.view.documents.uploading': 'Caricamento documento',
    'notebook.view.input.disabledTooltip': 'Seleziona almeno una risorsa caricata per iniziare a chattare',
    'notebook.view.input.placeholder': 'Chiedi informazioni sui tuoi documenti...',
    ...
    'notebooks.delete.message': 'Non vedrai più questo quaderno qui. Questo eliminerà anche le attività correlate come prompt, risposte e feedback dalla tua attività Lightspeed.',
    ...
    'notebooks.prompts.vulnerabilities.title': 'Mostra le mie vulnerabilità critiche',
