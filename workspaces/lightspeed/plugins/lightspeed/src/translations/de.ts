...
const lightspeedTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    'chatbox.emptyState.noFavorites': 'Keine Favoriten hinzugefügt',
    ...
    'conversation.addToFavorites': 'Zu Favoriten hinzufügen',
    'conversation.removeFromFavorites': 'Aus Favoriten entfernen',
    ...
    'conversation.category.favorites': 'Favoriten',
    ...
    // lightspeed settings
    'settings.favorites.enable': 'Chat-Favoriten aktivieren',
    'settings.favorites.disable': 'Chat-Favoriten deaktivieren',
    'settings.favorites.enabled.description':
      'Chat-Favoriten sind derzeit aktiviert',
    'settings.favorites.disabled.description':
      'Chat-Favoriten sind derzeit deaktiviert',
  },
});
