...
const lightspeedTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'lcore.loadError.description': 'Le backend Lightspeed n\'a pas renvoyé de liste de modèles. Vérifiez que le service est démarré et joignable, puis réessayez.',
    ...
    'lcore.notConfigured.description': 'Lightspeed nécessite un LLM enregistré. Contactez l\'administrateur de la plateforme de votre organisation pour finaliser la configuration.',
    'lcore.notConfigured.developerLightspeedDocs': 'Configuration de Developer Lightspeed',
    'lcore.notConfigured.title': 'Connectez un LLM pour commencer',
    'mcp.settings.closeAriaLabel': 'Fermer les paramètres MCP',
    'mcp.settings.closeConfigureModalAriaLabel': 'Fermer la fenêtre de configuration',
    ...
    'mcp.settings.modalDescription': 'Les identifiants sont chiffrés au repos et limités à votre profil. Lightspeed fonctionnera avec exactement vos autorisations.',
    ...
    'mcp.settings.selectedCount': '{{selectedCount}} sur {{totalCount}} sélectionnés',
    ...
    'mcp.settings.token.invalidCredentials': 'Identifiants invalides. Vérifiez l’URL du serveur et le jeton.',
    'mcp.settings.token.savingAndValidating': 'Enregistrement et validation du jeton...',
    ...
    'mcp.settings.usingAdminCredential': 'Les identifiants fournis par l’administrateur sont utilisés. Saisissez un jeton personnel pour les remplacer pour votre compte.',
    ...
    'notebook.document.delete.description': 'Êtes-vous sûr de vouloir supprimer <documentName/> de ce carnet ? Cette action est irréversible.',
    'notebook.document.delete.success': '« {{documentName}} » supprimé avec succès.',
    'notebook.document.delete.title': 'Supprimer la ressource ?',
    'notebook.overwrite.modal.action': 'Écraser',
    'notebook.overwrite.modal.description': 'Les fichiers suivants existent déjà dans ce carnet. Voulez-vous les écraser avec les nouvelles versions ?',
    ...
    'notebook.upload.error.tooManyFiles': 'Erreur de chargement : {{max}} fichiers maximum autorisés.',
    'notebook.upload.error.unsupportedType': 'Erreur de chargement : type(s) de fichier non pris en charge. Veuillez charger uniquement des types de fichiers pris en charge.',
    ...
    'notebook.view.documents.maxReached': 'Maximum 10 documents autorisés. Supprimez un document pour en charger un nouveau.',
    ...
    'notebook.view.input.placeholder': 'Posez des questions sur vos documents...',
    ...
    'notebooks.delete.message': 'Vous ne verrez plus ce carnet ici. Cela supprimera également l’activité associée comme les requêtes, réponses et retours depuis votre activité Lightspeed.',
    ...
    'notebooks.empty.description': 'Créez un nouveau carnet pour organiser vos sources et générer des informations alimentées par l’IA.',
    'notebooks.empty.title': 'Aucun carnet créé',
    'notebooks.prompts.accessIssue.title': 'Aidez-moi avec un problème d\'accès',
    'notebooks.prompts.coreConcepts.title': 'Quels sont les concepts fondamentaux ?',
    'notebooks.prompts.vulnerabilities.title': 'Afficher mes vulnérabilités critiques',
    'notebooks.rename.action': 'Envoyer',
    'notebooks.rename.description': 'Veuillez saisir le nouveau nom de ce carnet et cliquer sur Envoyer pour continuer.',
    ...
    'permission.required.description': 'Pour afficher <subject/>, veuillez contacter votre administrateur pour qu\'il vous donne la permission <permissions/>.',
