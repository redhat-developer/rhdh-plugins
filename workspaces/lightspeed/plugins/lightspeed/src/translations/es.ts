...
const lightspeedTranslationEs = createTranslationMessages({
  ...
  messages: {
    ...
    'chatbox.emptyState.noFavorites': 'No se han agregado favoritos',
    ...
    'conversation.addToFavorites': 'Agregar a favoritos',
    'conversation.removeFromFavorites': 'Quitar de favoritos',
    ...
    'conversation.category.favorites': 'Favoritos',
    ...
    // lightspeed settings
    'settings.favorites.enable': 'Habilitar favoritos de chat',
    'settings.favorites.disable': 'Deshabilitar favoritos de chat',
    'settings.favorites.enabled.description':
      'Los favoritos de chat están actualmente habilitados',
    'settings.favorites.disabled.description':
      'Los favoritos de chat están actualmente deshabilitados',
  },
});
