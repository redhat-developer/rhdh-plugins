...
export const lightspeedMessages = {
  ...
  'chatbox.emptyState.noFavorites': 'No favorites added',
  ...
  'conversation.addToFavorites': 'Add to favorites',
  'conversation.removeFromFavorites': 'Remove from favorites',
  ...
  'conversation.category.favorites': 'Favorites',
  ...
  // lightspeed settings
  'settings.favorites.enable': 'Enable chat favorites',
  'settings.favorites.disable': 'Disable chat favorites',
  'settings.favorites.enabled.description':
    'Favorite chats are currently enabled',
  'settings.favorites.disabled.description':
    'Favorite chats are currently disabled',
};
