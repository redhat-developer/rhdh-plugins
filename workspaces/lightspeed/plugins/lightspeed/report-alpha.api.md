...
readonly "chatbox.emptyState.noFavorites": string;
...
readonly "conversation.addToFavorites": string;
readonly "conversation.removeFromFavorites": string;
...
readonly "conversation.category.favorites": string;
...
readonly "settings.favorites.enable": string;
readonly "settings.favorites.disable": string;
readonly "settings.favorites.enabled.description": string;
readonly "settings.favorites.disabled.description": string;
}>;
