...
> = createTranslationMessages({
  ...
  messages: {
    ...
    'deleteDialog.body': 'Möchten Sie {{resourceName}} wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
    'agents.emptyTitle': 'Keine Agents registriert',
    'agents.emptyDescription': 'Umgebungs-Agents registrieren sich bei der Steuerungsebene und senden periodische Heartbeats. Registrieren Sie einen Agent, damit DCM Arbeitsauslastungen in externen Umgebungen verwalten kann.',
    ...
    'agents.form.nameHelper': 'Eindeutige Slug-Kennung – nur Kleinbuchstaben, Zahlen und Bindestriche',
    ...
    'agents.form.serviceTypesHelper': 'Servicetypen, die dieser Agent bereitstellen kann',
    'agents.form.costLabel': 'Kosten*',
    'agents.form.costHelper': 'Relative Kostengewichtung für Platzierungsentscheidungen',
    'agents.form.topicNameLabel': 'Themenname*',
    'agents.form.topicNamePlaceholder': 'z. B. dcm.agent.env-agent-west-1',
    'agents.form.topicNameHelper': 'NATS-Themenname; muss mit dcm.agent beginnen.',
    'policies.emptyTitle': 'Keine Richtlinien definiert',
    'policies.emptyDescription': 'Erstellen Sie OPA Rego-Richtlinien, um Governance-Regeln für DCM-Ressourcen durchzusetzen. Richtlinien können global oder pro Benutzer festgelegt werden.',
    ...
    'policies.form.displayNameHelper': 'Für Menschen lesbarer Name für diese Richtlinie',
    'policies.form.descriptionLabel': 'Beschreibung',
    'policies.form.descriptionHelper': 'Optional – Beschreiben Sie den Zweck dieser Richtlinie',
    ...
    'policies.form.priorityHelper': '1 (höchster Wert) – 1000 (niedrigster Wert), Standardwert 500 – muss pro Richtlinientyp eindeutig sein',
    'policies.form.regoCodeLabel': 'Rego-Code*',
    'policies.form.regoCodeHelper': 'Die OPA Rego-Richtlinie wird vom Platzierungsmanager bewertet.',
    ...
    'serviceTypes.emptyDescription': 'Servicetypen definieren das Vorlagenschema für Katalogelemente.',
    ...
    'catalogItems.emptyDescription': 'Katalogelemente sind Servicevorlagen, die Entwickler bereitstellen können. Jedes Katalogelement verweist auf einen oder mehrere Servicetypen und definiert die Felder, die zur Anpassung zur Verfügung stehen.',
    ...
    'catalogItems.form.importTooltip': 'Füllen Sie das Formular anhand einer JSON- oder YAML-Katalogelementdefinition aus',
    'catalogItems.form.importError': 'Datei konnte nicht importiert werden – überprüfen Sie, ob es sich um gültiges JSON oder YAML handelt.',
    'catalogItems.form.displayNameLabel': 'Anzeigename*',
    'catalogItems.form.displayNameHelper': 'Für Menschen lesbarer Name für dieses Katalogelement (max. 63 Zeichen)',
    'catalogItems.form.apiVersionLabel': 'API-Version*',
    'catalogItems.form.apiVersionHelper': 'Muss dem Muster v<number>[alpha|beta][Zahl] folgen – z. B. v1, v1alpha1',
    'catalogItems.form.serviceTypeLabel': 'Servicetyp*',
    'catalogItems.form.serviceTypeHelperEdit': 'Der Servicetyp kann nach seiner Erstellung nicht mehr geändert werden',
    'catalogItems.form.serviceTypeHelperNoTypes': 'Keine Servicetypen verfügbar – erstellen Sie einen auf der Registerkarte „Servicetypen“',
    'catalogItems.form.serviceTypeHelperDefault': 'Wählen Sie den Servicetyp aus, auf dem diese Ressource basiert',
    'catalogItems.form.fieldsLabel': 'Felder*',
    'catalogItems.form.fieldsCaption': '(mindestens eines erforderlich)',
    'catalogItems.form.fieldsErrorEmpty': 'Fügen Sie mindestens ein Feld mit einem nicht leeren Pfad hinzu.',
    'catalogItems.form.fieldAddButton': 'Feld hinzufügen',
    'catalogItems.form.fieldAddTooltip': 'Füllen Sie den Pfad des letzten Feldes aus, bevor Sie ein neues hinzufügen',
    ...
    'catalogItems.form.fieldDefaultValueHelper': 'Beliebiger JSON-Wert – z. B. 42, "hello", true, [1,2]',
    ...
    'catalogItems.form.schemaDialogHelper': 'JSON-Schema-Objekt – z. B. {"type":"integer","minimum":0}',
    'catalogItems.form.schemaDialogCancel': 'Abbrechen',
    'catalogItems.form.schemaDialogApply': 'Anwenden',
    'catalogItems.form.schemaMustBeObject': 'Muss ein JSON-Objekt sein, kein Array oder Grundtyp',
    ...
    'catalogItems.wizard.resourcesDescription': 'Fügen Sie eine oder mehrere Ressourcen hinzu. Jede Ressource referenziert einen Servicetyp und definiert ihre eigenen Feldkonfigurationen.',
    ...
    'catalogItems.wizard.resourceNameHelper': 'Eindeutige Kennung innerhalb dieses Katalogelements – z. B. app, ordersDb',
    'catalogItems.wizard.requiresResourcesLabel': 'Erfordert Ressourcen',
    'catalogItems.wizard.requiresResourcesHelper': 'Wählen Sie andere Ressourcen aus, die vor dieser bereitgestellt werden müssen',
    'catalogItems.wizard.apiVersionImmutable': 'Die API-Version kann nach der Erstellung nicht mehr geändert werden',
    'instances.emptyTitle': 'Keine Instanzen bereitgestellt',
    'instances.emptyDescription': 'Katalogelementinstanzen stellen bereitgestellte Services dar. Erstellen Sie eine Instanz aus einem Katalogelement, um einen Service für einen registrierten Umgebungs-Agent bereitzustellen.',
    ...
    'instances.rehydrateSuccess': 'Katalogelementinstanz erfolgreich wiederhergestellt.',
    ...
    'instances.rehydrateDialogBody': 'Durch das Wiederherstellen von {{instanceName}} wird die Ressource erneut bereitgestellt und ggf. eine neue Ressourcen-ID zugewiesen. Diese Aktion kann nicht rückgängig gemacht werden.',
    ...
    'instances.form.displayNameHelper': 'Für Menschen lesbarer Name für diese bereitgestellte Instanz (max. 63 Zeichen)',
    'instances.form.catalogItemLabel': 'Katalogelement*',
    'instances.form.catalogItemSelect': 'Wählen Sie ein Katalogelement aus…',
    'instances.form.catalogItemHelperNoItems': 'Es sind keine Katalogelemente verfügbar – erstellen Sie eines auf der Registerkarte „Katalogelemente“.',
    'instances.form.catalogItemHelperDefault': 'Wählen Sie das Katalogelement aus, aus dem Sie eine Instanz bereitstellen möchten',
    'instances.form.apiVersionLabel': 'API-Version*',
    'instances.form.apiVersionHelper': 'Muss dem Muster v<number>[alpha|beta][Zahl] folgen – z. B. v1, v1alpha1',
    'instances.form.fieldValuesSection': 'Feldwerte',
    'instances.form.fieldValuesSectionHint': '(bearbeitbare Felder, die durch dieses Katalogelement definiert werden)',
    'instances.form.noEditableFields': 'Diese Ressource enthält keine bearbeitbaren Felder.',
    'instances.wizard.tabOverview': 'Übersicht',
    'resources.emptyTitle': 'Keine Ressourcen gefunden',
    'resources.emptyDescription': 'Hier werden die über DCM bereitgestellten Servicetyp-Instanzen angezeigt.',
    ...
    'validation.agent.namePattern': 'Zulässig sind nur Kleinbuchstaben, Zahlen und Bindestriche (muss mit einem Buchstaben beginnen)',
    'validation.agent.environmentRequired': 'Umgebung ist erforderlich',
    'validation.agent.serviceTypesRequired': 'Mindestens ein Servicetyp ist erforderlich.',
    'validation.agent.costRequired': 'Kosten ist erforderlich',
    'validation.agent.topicNameRequired': 'Themenname ist erforderlich',
    'validation.agent.topicNamePattern': 'Der Themenname muss mit dcm.agent beginnen.',
    ...
    'validation.policy.displayNameMax': 'Der Anzeigename darf max. 255 Zeichen lang sein',
    'validation.policy.descriptionMax': 'Die Beschreibung darf max. 255 Zeichen lang sein',
    ...
    'validation.policy.regoCodePackage': 'Muss eine Paketdeklaration enthalten – z. B. „package dcm.placement“',
    ...
    'validation.catalogItem.displayNameMax': 'Der Anzeigename darf max. 63 Zeichen lang sein',
    'validation.catalogItem.apiVersionRequired': 'API-Version ist erforderlich',
    'validation.catalogItem.apiVersionPattern': 'Muss dem Muster v<number>[alpha|beta][Zahl] folgen – z. B. v1, v1alpha1',
    ...
    'validation.catalogItem.resourceNameDuplicate': 'Ressourcenname muss innerhalb des Katalogelements eindeutig sein',
    'validation.catalogItem.resourceNamePattern': 'Zulässig sind nur Buchstaben, Zahlen, Bindestriche und Unterstriche (muss mit einem Buchstaben beginnen)',
    'validation.catalogItem.requiresResourcesCycle': 'Zirkuläre Abhängigkeit erkannt – diese Ressource benötigt sich indirekt selbst',
    'validation.catalogItem.resourcesRequired':
      'Mindestens eine Ressource ist erforderlich',
    'validation.catalogItem.duplicatePath': 'Doppelter Pfad – Pfade müssen eindeutig sein',
    'validation.catalogItem.invalidJson': 'JSON ungültig – korrigieren Sie die Syntax oder verwenden Sie einen einfachen Zeichenkettenwert',
    'validation.catalogItem.schemaMustBeObject': 'Muss ein JSON-Objekt sein – z. B. {"type":"integer"}',
    'validation.catalogItem.schemaMinMaxConflict': 'Der Minimalwert ({{min}}) darf den Maximalwert ({{max}}) nicht überschreiten',
    'validation.catalogItem.defaultBelowMin': 'Der Standardwert ({{value}}) liegt unter dem Schemamindestwert ({{min}}).',
    'validation.catalogItem.defaultAboveMax': 'Der Standardwert ({{value}}) überschreitet den Schemahöchstwert ({{max}}).',
    ...
    'validation.instance.displayNameMax': 'Der Anzeigename darf max. 63 Zeichen lang sein',
    ...
    'validation.instance.apiVersionPattern': 'Muss dem Muster v<number>[alpha|beta][Zahl] folgen – z. B. v1, v1alpha1',
