...
> = createTranslationMessages({
  ...
  messages: {
    ...
    'validation.policy.displayNameMax':
      "Le nom d'affichage doit comporter au maximum 255 caract\u00e8res",
    'validation.policy.descriptionMax':
      'La description doit comporter au maximum 255 caract\u00e8res',
    'validation.policy.policyTypeRequired':
      'Le type de politique est obligatoire',
    'validation.policy.policyTypeOneOf': 'Doit \u00eatre GLOBAL ou USER',
    'validation.policy.priorityType':
      'La priorit\u00e9 doit \u00eatre un nombre',
    'validation.policy.priorityRequired': 'La priorit\u00e9 est obligatoire',
    'validation.policy.priorityInteger':
      'La priorit\u00e9 doit \u00eatre un nombre entier',
    'validation.policy.priorityMin':
      'La priorit\u00e9 doit \u00eatre d\u2019au moins 1',
    'validation.policy.priorityMax':
      'La priorit\u00e9 doit \u00eatre d\u2019au plus 1000',
    'validation.policy.regoCodeRequired': 'Le code Rego est obligatoire',
    'validation.policy.regoCodeEmpty':
      'Le code Rego ne peut pas \u00eatre vide',
    'validation.policy.regoCodePackage':
      'Doit contenir une d\u00e9claration de paquet \u2014 ex. "package dcm.placement"',
    'validation.catalogItem.displayNameRequired':
      "Le nom d'affichage est obligatoire",
    'validation.catalogItem.displayNameEmpty':
      "Le nom d'affichage ne peut pas \u00eatre vide",
    'validation.catalogItem.displayNameMax':
      "Le nom d'affichage doit comporter au maximum 63 caract\u00e8res",
    'validation.catalogItem.apiVersionRequired':
      "La version de l'API est obligatoire",
    ...
    'validation.catalogItem.defaultBelowMin':
      'La valeur par d\u00e9faut ({{value}}) est inf\u00e9rieure au minimum du sch\u00e9ma ({{min}})',
    'validation.catalogItem.defaultAboveMax':
      'La valeur par d\u00e9faut ({{value}}) d\u00e9passe le maximum du sch\u00e9ma ({{max}})',
    ...
    'validation.instance.catalogItemRequired':
      '\u00c9l\u00e9ment de catalogue obligatoire',
    ...
    'validation.instance.fieldMustBeNumber': 'Doit \u00eatre un nombre valide',
    'validation.instance.fieldMin': 'Doit \u00eatre au moins {{min}}',
    'validation.instance.fieldMax': 'Doit \u00eatre au plus {{max}}',
  },
});
