...
**Evaluation order:** `scorecard.disabledMetrics` is checked first. If the metric is in that list, it is always excluded and the rest is ignored. Otherwise, `entityOverrides.disabledMetrics` and the entity annotation are applied.

| `scorecard.disabledMetrics` | `entityOverrides.disabledMetrics.enabled` | `entityOverrides.disabledMetrics.except` | Entity annotation lists this metric? | **Metric excluded?** |
| --------------------------- | ----------------------------------------- | ---------------------------------------- | ------------------------------------ | -------------------- |
...
- **`entityOverrides.disabledMetrics.enabled = false`**  
...
- **`entityOverrides.disabledMetrics.enabled = true`**  
