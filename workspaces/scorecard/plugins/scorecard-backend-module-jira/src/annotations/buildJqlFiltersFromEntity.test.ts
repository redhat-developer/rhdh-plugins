...
type RequiredFilterAnnotations = Required<JiraFilterAnnotations>;

describe('buildJqlFiltersFromEntity', () => {
  const annotationFilterCases = [
    {
      name: 'open issues',
      keys: OPEN_ISSUES_FILTER_ANNOTATIONS as RequiredFilterAnnotations,
      options: undefined,
      missingProjectError: `Missing required '${PROJECT_KEY}' annotation for entity 'mock-entity'`,
    },
    {
      name: 'incidents',
      keys: INCIDENT_FILTER_ANNOTATIONS as RequiredFilterAnnotations,
