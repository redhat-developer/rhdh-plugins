...
export class GithubOpenIssuesProvider implements MetricProvider<'number'> {
  ...
  static fromConfig(config: Config): GithubOpenIssuesProvider {
    return new GithubOpenIssuesProvider(config);
  }
  ...
  async calculateMetric(entity: Entity): Promise<number> {
    ...
    return this.githubClient.getOpenIssuesCount(target, repository);
  }
}
