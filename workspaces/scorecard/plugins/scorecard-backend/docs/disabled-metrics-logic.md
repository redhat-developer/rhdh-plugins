...
| ----------------------------------------------- | --------------------------- | ------------------------------------------- | ------------------------------------------- | ----------------------------------------------------------------- | --------------------------------------------- |
| Yes                                             | —                           | —                                           | —                                           | —                                                                 | **Yes**                                       |
| No                                              | `false`                     | ignored                                     | ignored                                     | Yes                                                               | **No** (all annotations ignored)              |
| No                                              | `true` (or unset)           | `false`                                     | ignored                                     | No                                                                | **No**                                        |
| No                                              | `true` (or unset)           | `false`                                     | ignored                                     | Yes                                                               | **No** (annotation ignored, forced to run)    |
