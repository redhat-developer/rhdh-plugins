...
const mountPoints: HomePageCardMountPoint[] = [
  ...
  },
  {
    Component: ScorecardHomepageCard as ComponentType,
    config: {
      id: 'scorecard-entitiesWithOpenPrs',
      ...
      props: {
        aggregationId: 'entitiesWithOpenPrs',
      },
    },
  },
  {
