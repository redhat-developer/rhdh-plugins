# Augment Security Documentation

This directory contains comprehensive documentation and **automated setup scripts** for configuring security for the Augment plugin with Keycloak.
...
| Plugin Access Control | Backstage RBAC | `augment.access` permission     |
...
```
┌─────────────┐     ┌─────────────┐     ┌─────────────┐     ┌─────────────┐
│  Keycloak   │────▶│  Backstage  │────▶│ Augment│────▶│ MCP Server  │
...
- **Augment Plugin**: File an issue in the rhdh-plugins repository
