      ...
      e.exports = function (e) {
        const a =
          ...
          o = [
            ...
            {
              className: 'function',
              begin: n(/def\s+/, ((_ = a + '\\s*(\\(|;|$)'), n('(?=', _, ')'))),
              relevance: 0,
              keywords: 'def',
              end: '$|;',
              contains: [e.inherit(e.TITLE_MODE, { begin: a }), l].concat(b),
            },
            { begin: e.IDENT_RE + '::' },
            {
              className: 'symbol',
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_ruby.363274e3.chunk.js.map
