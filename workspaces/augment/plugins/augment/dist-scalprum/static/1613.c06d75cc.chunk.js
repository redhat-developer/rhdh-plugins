/*! For license information please see 1613.c06d75cc.chunk.js.LICENSE.txt */
'use strict';
    ...
    21613(e, t, r) {
      ...
      function s(e) {
        return (
          ...
          m(
            function (e, t) {
              let { pathname: r, search: a, hash: n } = e.location;
              return h(
                '',
                { pathname: r, search: a, hash: n },
      ...
      function m(e, t, r, i) {
        ...
        function g() {
          ...
          let e = v(),
            t = null == e ? null : e - y;
          ((y = e), m && m({ action: p, location: w.location, delta: t }));
        }
        function b(e) {
          let t =
        ...
        null == y && ((y = 0), d.replaceState(a({}, d.state, { idx: y }), ''));
        let w = {
          get action() {
            return p;
          },
          ...
          push: function (e, t) {
            ...
            l && m && m({ action: p, location: w.location, delta: 1 });
          },
          replace: function (e, t) {
            ...
            let o = u(a, y),
              i = w.createHref(a);
            (d.replaceState(o, '', i),
              l && m && m({ action: p, location: w.location, delta: 0 }));
          },
          go: e => d.go(e),
        };
        return w;
      ...
      function g(e, t, r, n) {
        return (
          ...
          e.map((e, o) => {
            ...
            {
              let r = a({}, e, t(e), { id: s, children: void 0 });
              return (
                (n[s] = r),
                e.children && (r.children = g(e.children, t, i, n)),
                r
              );
            }
          })
      ...
      function P(e, t) {
        ...
        return (
          ...
          r
            .filter(e => !x(e))
            .reduce((e, t) => e + (E.test(t) ? 3 : '' === t ? 1 : 10), a)
        );
      }
      function k(e, t, r) {
        void 0 === r && (r = !1);
        ...
        for (let e = 0; e < a.length; ++e) {
          ...
          (Object.assign(n, d.params),
            i.push({
              params: n,
              pathname: H([o, d.pathname]),
              pathnameBase: W(H([o, d.pathnameBase])),
              route: u,
            }),
            '/' !== d.pathnameBase && (o = H([o, d.pathnameBase])));
        }
        return i;
      }
      function M(e, t) {
              ...
              n =
                ...
                e
                  ...
                  .replace(
                    /\/:([\w-]+)(\?)?/g,
                    (e, t, r) => (
                      a.push({ paramName: t, isOptional: null != r }),
                      r ? '/?([^\\/]+)?' : '/([^\\/]+)'
                    ),
                  );
            return (
      ...
      function _(e, t) {
        ...
        if (a)
          if (((i = a), C.test(i))) r = a;
            ...
            r = a.startsWith('/') ? T(a.substring(1), '/') : T(a, t);
          }
        else r = t;
        var i;
        return { pathname: r, search: F(n), hash: B(o) };
      }
      function T(e, t) {
      ...
      function I(e, t, r, n) {
        ...
        let d = _(o, i),
          ...
          h = (s || '.' === l) && r.endsWith('/');
        return (
          d.pathname.endsWith('/') || (!u && !h) || (d.pathname += '/'),
          d
        );
      }
      const H = e => e.join('/').replace(/\/\/+/g, '/'),
        ...
        $ = function (e, t) {
          ...
          return (
            ...
            new Response(JSON.stringify(e), a({}, r, { headers: n }))
          );
        };
      ...
      class q {
        constructor(e, t) {
          ...
          ((this.unlistenAbortSignal = () =>
            ...
            (this.data = Object.entries(e).reduce((e, t) => {
              let [r, a] = t;
              return Object.assign(e, { [r]: this.trackPromise(r, a) });
            }, {})),
        ...
        onSettle(e, t, r, a) {
          if (this.controller.signal.aborted && r instanceof N)
            return (
              this.unlistenAbortSignal(),
          ...
          return void 0 === a
            ? (Object.defineProperty(e, '_error', { get: () => r }),
              this.emit(!1, t),
              Promise.reject(r))
            : (Object.defineProperty(e, '_data', { get: () => a }),
              this.emit(!1, t),
              a);
        }
        emit(e, t) {
      ...
      const V = function (e, t) {
        ...
        J = function (e, t) {
          ...
          return (
            n.set('Location', e),
            new Response(null, a({}, r, { headers: n }))
          );
        },
        Y = (e, t) => {
          let r = J(e, t);
      ...
      function ue(e) {
        ...
        let s,
          ...
          C = b(p, e.history.location, m),
          _ = !1,
          T = null;
        if (null == C && !D) {
          let t = _e(404, { pathname: e.history.location.pathname }),
            { matches: r, route: a } = Ce(p);
          ((C = r), (T = { [a.id]: t }));
        }
        if (
          (C &&
            !e.hydrationData &&
            dt(C, p, e.history.location.pathname).active &&
            (C = null),
          C)
        )
          if (C.some(e => e.route.lazy)) l = !1;
            ...
            if (E.v7_partialHydration) {
              ...
              if (r) {
                let e = C.findIndex(e => void 0 !== r[e.route.id]);
                l = C.slice(0, e + 1).every(e => !ye(e.route, t, r));
              } else l = C.every(e => !ye(e.route, t, r));
            } else l = null != e.hydrationData;
          else l = !0;
        else if (((l = !1), (C = []), E.v7_partialHydration)) {
          let t = dt(null, p, e.history.location.pathname);
          t.active && t.matches && ((_ = !0), (C = t.matches));
        }
        let O,
          U,
          z = {
        ...
        function ue(e, t) {
          ...
          (E.v7_fetcherPersist &&
            z.fetchers.forEach((e, t) => {
              'idle' === e.state && (te.has(t) ? n.push(t) : r.push(t));
            }),
            te.forEach(e => {
              z.fetchers.has(e) || V.has(e) || n.push(e);
            }),
            [...P].forEach(e =>
              e(z, {
                deletedFetchers: n,
            ...
            E.v7_fetcherPersist
              ? (r.forEach(e => z.fetchers.delete(e)), n.forEach(e => Qe(e)))
              : n.forEach(e => te.delete(e)));
        }
        function pe(t, r, o) {
          var i, l;
          let c,
            { flushSync: d } = void 0 === o ? {} : o,
            u =
              null != z.actionData &&
              null != z.navigation.formMethod &&
              Be(z.navigation.formMethod) &&
          ...
          c = r.actionData
            ...
            : u
              ...
              : null;
          let h = r.loaderData
              ? Le(z.loaderData, r.loaderData, r.matches || [], r.errors)
              : z.loaderData,
            f = z.blockers;
          ...
          if (
            ...
            $ ||
              ...
              (I === n.Push
                ...
                : I === n.Replace && e.history.replace(t, t.state)),
            I === n.Pop)
          ) {
            ...
            (e
              ? e.add(t.pathname)
              : ((e = new Set([t.pathname])), F.set(z.location.pathname, e)),
              (m = { currentLocation: z.location, nextLocation: t }));
          }
          (ue(
            a({}, r, {
              ...
              navigation: oe,
              revalidation: 'idle',
              restoreScrollPosition: ct(t, r.matches || z.matches),
              preventScrollReset: y,
              blockers: f,
            }),
            { viewTransitionOpts: m, flushSync: !0 === d },
          ),
            (I = n.Pop),
            (H = !1),
            (W = !1),
        ...
        async function ve(t, r, o) {
          (O && O.abort(),
            ...
            (H = !0 === (o && o.preventScrollReset)),
            (W = !0 === (o && o.enableViewTransition)));
          let i = s || p,
          ...
          if (
            ...
            ((u = z.location),
            (h = r),
            u.pathname === h.pathname &&
              u.search === h.search &&
              ('' === u.hash
                ? '' !== h.hash
                : u.hash === h.hash || '' !== h.hash)) &&
            !(o && o.submission && Be(o.submission.formMethod))
          )
            return void pe(r, { matches: c }, { flushSync: d });
          var u, h;
          let f = dt(c, i, r.pathname);
          if ((f.active && f.matches && (c = f.matches), !c)) {
            let { error: e, notFoundMatches: t, route: a } = it(r.pathname);
            return void pe(
              r,
              { matches: t, loaderData: {}, errors: { [a.id]: e } },
              { flushSync: d },
            );
          }
          O = new AbortController();
          let v,
            g = xe(e.history, r, O.signal, o && o.submission);
          if (o && o.pendingError)
            v = [je(c).route.id, { type: y.error, error: o.pendingError }];
            ...
            let t = await (async function (t, r, a, o, i, s) {
              ...
              if (
                (ue({ navigation: c }, { flushSync: !0 === s.flushSync }), i)
              ) {
                ...
                if ('error' === e.type) {
                  ...
                  return {
                    ...
                    pendingActionResult: [t, { type: y.error, error: e.error }],
                  };
                }
                if (!e.matches) {
                  let {
                  ...
                  return {
                    matches: e,
                    pendingActionResult: [a.id, { type: y.error, error: t }],
                  };
                }
                o = e.matches;
              }
              ...
              if (d.route.action || d.route.lazy) {
                if (
                  ((l = (await Pe('action', z, t, [d], o, null))[d.route.id]),
                  t.signal.aborted)
                )
              ...
              if (He(l)) {
                ...
                return (
                  ...
                  await we(t, l, !0, { submission: a, replace: r }),
                  { shortCircuited: !0 }
                );
              }
              if (ze(l)) throw _e(400, { type: 'defer-action' });
              if (Ie(l)) {
                let e = je(o, d.route.id);
                return (
                  !0 !== (s && s.replace) && (I = n.Push),
                  { matches: o, pendingActionResult: [e.route.id, l] }
                );
              }
              return { matches: o, pendingActionResult: [d.route.id, l] };
            ...
            if (t.pendingActionResult) {
              ...
              if (Ie(a) && Q(a.error) && 404 === a.error.status)
                return (
                  (O = null),
                  void pe(r, {
                    matches: t.matches,
          ...
          let {
            ...
            let y = i || Ye(r, l),
              v = l || c || Je(y),
              g = !($ || (E.v7_partialHydration && u));
            if (o) {
              if (g) {
                let e = ge(f);
                ue(
                  a({ navigation: y }, void 0 !== e ? { actionData: e } : {}),
                  { flushSync: h },
                );
              }
              ...
              if (!e.matches) {
                let { error: e, notFoundMatches: t, route: a } = it(r.pathname);
                return { matches: t, loaderData: {}, errors: { [a.id]: e } };
              }
              n = e.matches;
            }
            let b = s || p,
                  ...
                  a(
                    {
                      matches: n,
                      loaderData: {},
                      errors: f && Ie(f[1]) ? { [f[0]]: f[1].error } : null,
                    },
                    Ae(f),
                  ...
                  return (
                    e.forEach(e => {
                      let t = z.fetchers.get(e.key),
                        r = Xe(void 0, t ? t.data : void 0);
                      z.fetchers.set(e.key, r);
                    }),
                    new Map(z.fetchers)
                  );
                })(S)),
            ...
            let { loaderResults: D, fetcherResults: x } = await ke(
              z,
              n,
              w,
              S,
            ...
            (O && O.signal.removeEventListener('abort', R),
              S.forEach(e => V.delete(e.key)));
            let P = Te(D);
            if (P)
              return (
                await we(t, P.result, !0, { replace: d }),
                { shortCircuited: !0 }
              );
            if (((P = Te(x)), P))
              return (
            ...
            let { loaderData: k, errors: M } = Me(z, n, D, f, S, x, re);
            (re.forEach((e, t) => {
              e.subscribe(r => {
            ...
            let L = tt(),
              ...
              j = L || A || S.length > 0;
            return a(
              { matches: n, loaderData: k, errors: M },
              j ? { fetchers: new Map(z.fetchers) } : {},
            );
          })(
            g,
            r,
          ...
          w ||
            ((O = null),
            pe(r, a({ matches: S || c }, Ae(v), { loaderData: R, errors: D })));
        }
        function ge(e) {
          return e && !Ie(e[1])
            ? { [e[0]]: e[1].data }
        ...
        async function we(o, i, s, l) {
          ...
          i.response.headers.has('X-Remix-Revalidate') && (N = !0);
          let y = i.response.headers.get('Location');
          (c(y, 'Expected a Location header on the redirect Response'),
            (y = Ee(y, new URL(o.url), m, e.history)));
          let v = h(z.location, y, { _isRedirect: !0 });
          if (r) {
            let r = !1;
            ...
            if (r)
              return void (p ? t.location.replace(y) : t.location.assign(y));
          }
          O = null;
          let g =
              !0 === p || i.response.headers.has('X-Remix-Replace')
                ? n.Replace
                : n.Push,
            { formMethod: b, formAction: w, formEncType: S } = z.navigation;
          !d && !u && b && w && S && (d = Je(z.navigation));
          let R = d || u;
          if (ne.has(i.response.status) && R && Be(R.formMethod))
            await ve(g, v, {
              submission: a({}, R, { formAction: y }),
        ...
        async function Pe(e, t, r, n, o, s) {
          ...
          try {
              ...
              let f = i.map(e =>
                  e.route.lazy
                    ? (async function (e, t, r) {
                        ...
                        (Object.assign(o, i),
                          Object.assign(o, a({}, t(o), { lazy: void 0 })));
                      })(e.route, u, l)
                    : void 0,
                ),
                p = i.map((e, r) => {
                  ...
                  return a({}, e, {
                    ...
                    resolve: async r => (
                      ...
                      s
                              ...
                              if (a)
                                if (n) {
                                  ...
                                  if ((await a, (n = r.route[e]), !n)) {
                                    ...
                                    return { type: y.data, result: void 0 };
                                  }
                                  i = await l(n);
                                }
                              else {
                        ...
                        : Promise.resolve({ type: y.data, result: void 0 })
                    ),
                  });
                }),
                m = await e({
            ...
            return (
              n.forEach(t => {
                u[t.route.id] = { type: y.error, error: e };
              }),
              u
            );
          }
          for (let [e, t] of Object.entries(l))
            if (Ue(t)) {
              ...
              u[e] = {
                type: y.redirect,
                response: De(a, r, e, o, m, E.v7_relativeSplatPath),
              };
            } else u[e] = await Re(t);
          return u;
        }
        async function ke(t, r, a, n, o) {
          let i = t.matches,
            s = Pe('loader', 0, o, a, r, null),
            l = Promise.all(
              n.map(async t => {
                if (t.matches && t.match && t.controller) {
                  let r = (
                    await Pe(
                      'loader',
                      0,
                      xe(e.history, t.path, t.controller.signal),
                      [t.match],
                      t.matches,
                      t.key,
                    )
        ...
        function Fe(e, t, r, a) {
          void 0 === a && (a = {});
          let n = je(z.matches, t);
          (Qe(e),
            ue(
              { errors: { [n.route.id]: r }, fetchers: new Map(z.fetchers) },
        ...
        function Ke(e) {
          return (
            ...
            te.has(e) && te.delete(e),
            z.fetchers.get(e) || ie
          );
        }
        function Qe(e) {
          let t = z.fetchers.get(e);
          (!V.has(e) || (t && 'loading' === t.state && X.has(e)) || Ze(e),
            Z.delete(e),
            X.delete(e),
            G.delete(e),
            E.v7_fetcherPersist && te.delete(e),
            K.delete(e),
            z.fetchers.delete(e));
        }
        function Ze(e) {
        ...
        function tt() {
          let e = [],
            t = !1;
          for (let r of G) {
            let a = z.fetchers.get(r);
            (c(a, 'Expected fetcher: ' + r),
              'loading' === a.state && (G.delete(r), e.push(r), (t = !0)));
          }
          return (et(e), t);
        }
        function rt(e) {
          ...
          for (let [r, a] of X)
            if (a < e) {
              let e = z.fetchers.get(r);
              (c(e, 'Expected fetcher: ' + r),
                'loading' === e.state && (Ze(r), X.delete(r), t.push(r)));
            }
          return (et(t), t.length > 0);
        }
        function at(e) {
          (z.blockers.delete(e), ae.delete(e));
        }
        function nt(e, t) {
          let r = z.blockers.get(e) || se;
          c(
          ...
          let a = new Map(z.blockers);
          (a.set(e, t), ue({ blockers: a }));
        }
        function ot(e) {
          let { currentLocation: t, nextLocation: r, historyAction: a } = e;
          if (0 === ae.size) return;
          ...
          return s && 'proceeding' === s.state
            ? void 0
            : i({ currentLocation: t, nextLocation: r, historyAction: a })
              ? o
              : void 0;
        }
        function it(e) {
          let t = _e(404, { pathname: e }),
            r = s || p,
            { matches: a, route: n } = Ce(r);
          return (st(), { notFoundMatches: a, route: n, error: t });
        }
        function st(e) {
          let t = [];
          return (
        ...
        function dt(e, t, r) {
          if (D) {
            if (!e) return { active: !0, matches: w(t, r, m, !0) || [] };
            if (Object.keys(e[0].params).length > 0)
              return { active: !0, matches: w(t, r, m, !0) };
          }
        ...
        async function ut(e, t, r, a) {
          ...
          for (;;) {
            ...
            if (
              !d ||
              (n.length === d.length &&
                n.every((e, t) => e.route.id === d[t].route.id))
            )
        ...
        return (
          (u = {
            ...
            initialize: function () {
              if (
                ((x = e.history.listen(t => {
                  let { action: r, location: a, delta: n } = t;
              ...
              return (
                z.initialized ||
                  ve(n.Pop, z.location, { initialHydration: !0 }),
                u
              );
            },
            ...
            enableScrollRestoration: function (e, t, r) {
              if (
                ((k = e), (L = t), (M = r || null), !A && z.navigation === oe)
              ) {
                A = !0;
                let e = ct(z.location, z.matches);
            ...
            navigate: async function t(r, o) {
              ...
              let i = he(
                ...
                ),
                {
                  ...
                  submission: l,
                  error: c,
                } = fe(E.v7_normalizeFormMethod, !1, i, o),
                d = z.location,
                u = h(z.location, s, o && o.state);
              ...
              !0 === f
                ...
                : !1 === f ||
                  (null != l &&
                    Be(l.formMethod) &&
                    l.formAction === z.location.pathname + z.location.search &&
                    (p = n.Replace));
              let y =
            ...
            fetch: function (t, r, a, n) {
              ...
              let i = !0 === (n && n.flushSync),
                ...
                u = b(l, d, m),
                h = dt(u, l, d);
              if ((h.active && h.matches && (u = h.matches), !u))
                return void Fe(t, r, _e(404, { pathname: d }), {
                  flushSync: i,
                });
              let {
                path: f,
                submission: y,
                error: v,
              } = fe(E.v7_normalizeFormMethod, !0, d, n);
              if (v) return void Fe(t, r, v, { flushSync: i });
              let g = Ve(u, f),
                w = !0 === (n && n.preventScrollReset);
              y && Be(y.formMethod)
                ? (async function (t, r, a, n, o, i, l, d, u) {
                    function h(e) {
                      if (!e.route.action && !e.route.lazy) {
                        ...
                        return (Fe(t, r, e, { flushSync: l }), !0);
                      }
                      return !1;
                    }
                    if ((Oe(), Z.delete(t), !i && h(n))) return;
                    let f = z.fetchers.get(t);
                    We(
                      t,
                      (function (e, t) {
                        return {
                    ...
                    let y = new AbortController(),
                      v = xe(e.history, a, y.signal, u);
                    if (i) {
                      let e = await ut(o, new URL(v.url).pathname, v.signal, t);
                      if ('aborted' === e.type) return;
                      if ('error' === e.type)
                        return void Fe(t, r, e.error, { flushSync: l });
                      if (!e.matches)
                        return void Fe(t, r, _e(404, { pathname: a }), {
                          flushSync: l,
                        });
                      if (h((n = Ve((o = e.matches), a)))) return;
                    }
                    V.set(t, y);
                    let g = J,
                      w = (await Pe('action', 0, v, [n], o, t))[n.route.id];
                    if (v.signal.aborted)
                      return void (V.get(t) === y && V.delete(t));
                    if (E.v7_fetcherPersist && te.has(t)) {
                      if (He(w) || Ie(w)) return void We(t, Ge(void 0));
                    } else {
                      if (He(w))
                        return (
                          V.delete(t),
                      ...
                      if (Ie(w)) return void Fe(t, r, w.error);
                    }
                    if (ze(w)) throw _e(400, { type: 'defer-action' });
                    let S = z.navigation.location || z.location,
                      R = xe(e.history, S, y.signal),
                      D = s || p,
                      x =
                        'idle' !== z.navigation.state
                          ? b(D, z.navigation.location, m)
                          : z.matches;
                    ...
                    (L.filter(e => e.key !== t).forEach(e => {
                      let t = e.key,
                        r = z.fetchers.get(t),
                        a = Xe(void 0, r ? r.data : void 0);
                      (z.fetchers.set(t, a),
                        Ze(t),
                        e.controller && V.set(t, e.controller));
                    }),
                      ue({ fetchers: new Map(z.fetchers) }));
                    let A = () => L.forEach(e => Ze(e.key));
                    y.signal.addEventListener('abort', A);
                    let { loaderResults: j, fetcherResults: C } = await ke(
                      z,
                      x,
                      M,
                      L,
                    ...
                    (y.signal.removeEventListener('abort', A),
                      X.delete(t),
                      V.delete(t),
                      L.forEach(e => V.delete(e.key)));
                    let _ = Te(j);
                    if (_)
                      return we(R, _.result, !1, { preventScrollReset: d });
                    if (((_ = Te(C)), _))
                      return (
                        G.add(_.key),
                        we(R, _.result, !1, { preventScrollReset: d })
                      );
                    let { loaderData: T, errors: U } = Me(
                      z,
                      x,
                      j,
                      void 0,
                    ...
                    (rt(P),
                      'loading' === z.navigation.state && P > Y
                        ...
                        : (ue({
                            errors: U,
                            loaderData: Le(z.loaderData, T, x, U),
                            fetchers: new Map(z.fetchers),
                          }),
                          (N = !1)));
                  })(t, r, f, g, u, h.active, i, w, y)
                : (Z.set(t, { routeId: r, path: f }),
                  (async function (t, r, a, n, o, i, s, l, d) {
                    let u = z.fetchers.get(t);
                    We(t, Xe(d, u ? u.data : void 0), { flushSync: s });
                    let h = new AbortController(),
                      f = xe(e.history, a, h.signal);
                    if (i) {
                      let e = await ut(o, new URL(f.url).pathname, f.signal, t);
                      if ('aborted' === e.type) return;
                      if ('error' === e.type)
                        return void Fe(t, r, e.error, { flushSync: s });
                      if (!e.matches)
                        return void Fe(t, r, _e(404, { pathname: a }), {
                          flushSync: s,
                        });
                    ...
                    V.set(t, h);
                    let p = J,
                      m = (await Pe('loader', 0, f, [n], o, t))[n.route.id];
                    if (
                      (ze(m) && (m = (await qe(m, f.signal, !0)) || m),
                      ...
                      if (!te.has(t))
                        return He(m)
                          ...
                          : void (Ie(m)
                              ? Fe(t, r, m.error)
                              : (c(!ze(m), 'Unhandled fetcher deferred data'),
                                We(t, Ge(m.data))));
                      We(t, Ge(void 0));
                    }
                  })(t, r, f, g, u, h.active, i, w, y));
            ...
            revalidate: function () {
              (Oe(),
                ...
                'submitting' !== z.navigation.state &&
                  ('idle' !== z.navigation.state
                    ? ve(I || z.historyAction, z.navigation.location, {
                        overrideNavigation: z.navigation,
                        enableViewTransition: !0 === W,
                      })
                    : ve(z.historyAction, z.location, {
            ...
            deleteFetcher: function (e) {
              let t = (ee.get(e) || 0) - 1;
              (t <= 0
                ? (ee.delete(e), te.add(e), E.v7_fetcherPersist || Qe(e))
                : ee.set(e, t),
                ue({ fetchers: new Map(z.fetchers) }));
            },
            dispose: function () {
              (x && x(),
                ...
                P.clear(),
                O && O.abort(),
                z.fetchers.forEach((e, t) => Qe(t)),
                z.blockers.forEach((e, t) => at(t)));
            },
      ...
      function he(e, t, r, a, n, o, i, s) {
        ...
        let d = I(
          n || '.',
          z(l, o),
          j(e.pathname, r) || e.pathname,
          'path' === s,
        );
        if (
          (null == n && ((d.search = e.search), (d.hash = e.hash)),
          (null == n || '' === n || '.' === n) && c)
        ) {
          let e = Ke(d.search);
          if (c.route.index && !e)
        ...
        return (
          a &&
            '/' !== r &&
            (d.pathname = '/' === d.pathname ? r : H([r, d.pathname])),
          f(d)
        );
      }
      function fe(e, t, r, a) {
        if (
          ...
          return { path: r };
        if (a.formMethod && ((n = a.formMethod), !re.has(n.toLowerCase())))
          return { path: r, error: _e(405, { method: a.formMethod }) };
        var n;
        let o,
          i,
          s = () => ({ path: r, error: _e(400, { type: 'invalid-body' }) }),
          l = a.formMethod || 'get',
            ...
            let e =
              'string' == typeof a.body
                ...
                : a.body instanceof FormData ||
                    a.body instanceof URLSearchParams
                  ? Array.from(a.body.entries()).reduce((e, t) => {
                      let [r, a] = t;
                      return '' + e + r + '=' + a + '\n';
                    }, '')
                  : String(a.body);
        ...
        if (
          ...
          ((o = Pe(a.formData)), (i = a.formData));
        else if (a.body instanceof FormData) ((o = Pe(a.body)), (i = a.body));
        else if (a.body instanceof URLSearchParams) ((o = a.body), (i = ke(o)));
        else if (null == a.body)
          ((o = new URLSearchParams()), (i = new FormData()));
        else
          try {
            ((o = new URLSearchParams(a.body)), (i = ke(o)));
          } catch (e) {
            return s();
          }
        let h = {
          ...
          formAction: u,
          formEncType:
            (a && a.formEncType) || 'application/x-www-form-urlencoded',
          formData: i,
          json: void 0,
          text: void 0,
        };
        if (Be(h.formMethod)) return { path: r, submission: h };
        let m = p(r);
        return (
          t && m.search && Ke(m.search) && o.append('index', ''),
          (m.search = '?' + o),
          { path: f(m), submission: h }
        );
      }
      function pe(e, t, r) {
        void 0 === r && (r = !1);
      ...
      function me(e, t, r, n, o, i, s, l, c, d, u, h, f, p, m, y) {
        let v = y ? (Ie(y[1]) ? y[1].error : y[1].data) : void 0,
          g = e.createURL(t.location),
          w = e.createURL(o),
          S = r;
        i && t.errors
          ? (S = pe(r, Object.keys(t.errors)[0], !0))
          : y && Ie(y[1]) && (S = pe(r, y[0]));
        let R = y ? y[1].statusCode : void 0,
          ...
          E = S.filter((e, r) => {
            ...
            if (i) return ye(o, t.loaderData, t.errors);
            if (
              (function (e, t, r) {
              ...
              a(
                ...
                n,
                {
                  ...
                  defaultShouldRevalidate:
                    !D &&
                    (l ||
                      g.pathname + g.search === w.pathname + w.search ||
                      g.search !== w.search ||
                      ve(s, d)),
                },
              ),
      ...
      async function Se(e) {
        ...
        return (await Promise.all(r.map(e => e.resolve()))).reduce(
          (e, t, a) => Object.assign(e, { [r[a].route.id]: t }),
          {},
        );
      }
      async function Re(e) {
        ...
        if (Fe(t)) {
          ...
          return r === y.error
            ? {
                type: y.error,
                error: new G(t.status, t.statusText, e),
                statusCode: t.status,
                headers: t.headers,
              }
            : {
          ...
          ? We(t)
            ? t.data instanceof Error
              ...
              : {
                  ...
                  statusCode: Q(t) ? t.status : void 0,
                  headers:
                    null != (n = t.init) && n.headers
                      ? new Headers(t.init.headers)
                      : void 0,
                }
            : { type: y.error, error: t, statusCode: Q(t) ? t.status : void 0 }
          : (function (e) {
                let t = e;
                return (
                  t &&
      ...
      function Ee(e, t, r, a) {
        ...
        try {
          let t = a.createURL(e);
          if (n.includes(t.protocol))
            throw new Error('Invalid redirect location');
        } catch (e) {}
        return e;
      }
      function xe(e, t, r, a) {
        let n = e.createURL(Oe(t)).toString(),
          o = { signal: r };
        if (a && Be(a.formMethod)) {
          let { formMethod: e, formEncType: t } = a;
          ((o.method = e.toUpperCase()),
            'application/json' === t
              ...
              : 'text/plain' === t
                ? (o.body = a.text)
                : 'application/x-www-form-urlencoded' === t && a.formData
                  ? (o.body = Pe(a.formData))
                  : (o.body = a.formData));
        }
      ...
      function Pe(e) {
        ...
        for (let [r, a] of e.entries())
          t.append(r, 'string' == typeof a ? a : a.name);
        return t;
      }
      function ke(e) {
        let t = new FormData();
      ...
      function Me(e, t, r, n, o, i, s) {
        let { loaderData: l, errors: d } = (function (e, t, r, a, n) {
          let o,
            i = {},
            s = null,
            l = !1,
            d = {},
            u = r && Ie(r[1]) ? r[1].error : void 0;
          return (
            e.forEach(r => {
              ...
              if (
                ...
                let t = f.error;
                if ((void 0 !== u && ((t = u), (u = void 0)), (s = s || {}), n))
                  s[h] = t;
                else {
                  let r = je(e, h);
                ...
                ((i[h] = void 0),
                  l || ((l = !0), (o = Q(f.error) ? f.error.status : 500)),
                  f.headers && (d[h] = f.headers));
              } else
                ze(f)
                  ? (a.set(h, f.deferredData),
            ...
            void 0 !== u && r && ((s = { [r[0]]: u }), (i[r[0]] = void 0)),
            { loaderData: i, errors: s, statusCode: o || 200, loaderHeaders: d }
          );
        })(t, r, n, s, !1);
        return (
          o.forEach(t => {
            let { key: r, match: n, controller: o } = t,
              s = i[r];
            if (
              (c(s, 'Did not find corresponding fetcher result'),
              !o || !o.signal.aborted)
            )
              if (Ie(s)) {
                let t = je(e.matches, null == n ? void 0 : n.route.id);
                ((d && d[t.route.id]) ||
                  (d = a({}, d, { [t.route.id]: s.error })),
                  e.fetchers.delete(r));
              } else if (He(s))
                c(!1, 'Unhandled fetcher revalidation redirect');
              else if (ze(s)) c(!1, 'Unhandled fetcher deferred data');
              else {
                let t = Ge(s.data);
                e.fetchers.set(r, t);
              }
                ...
                : 405 === e &&
                  ...
                  n && r && a
                    ? (l =
                        ...
                        '", so there is no way to handle the request.')
                    : n &&
                      (l = 'Invalid request method "' + n.toUpperCase() + '"')),
          new G(e || 500, s, new Error(l), !0)
        );
      }
      function Te(e) {
        ...
        for (let e = t.length - 1; e >= 0; e--) {
          let [r, a] = t[e];
          if (He(a)) return { key: r, result: a };
        }
      }
      function Oe(e) {
        return f(a({}, 'string' == typeof e ? p(e) : e, { hash: '' }));
      }
      function Ue(e) {
        return Fe(e.result) && ae.has(e.result.status);
      }
      function ze(e) {
      ...
      async function $e(e, t, r, a, n) {
        ...
        for (let i = 0; i < o.length; i++) {
          ...
          let d = a.find(e => e.route.id === c.route.id),
            u = null != d && !ve(d, c) && void 0 !== (n && n[c.route.id]);
          ze(l) &&
            u &&
            (await qe(l, r, !1).then(e => {
              e && (t[s] = e);
            }));
        }
      }
      async function Ne(e, t, r) {
        for (let a = 0; a < r.length; a++) {
          let { key: n, routeId: o, controller: i } = r[a],
            s = t[n];
...
//# sourceMappingURL=1613.c06d75cc.chunk.js.map
