/*! For license information please see 8419.b4bd3595.chunk.js.LICENSE.txt */
'use strict';
    ...
    73657(e, t, n) {
      ...
      function S(e, t) {
        return (0, u.aE)({
          ...
          history: (0, u.zR)({ window: null == t ? void 0 : t.window }),
          hydrationData: (null == t ? void 0 : t.hydrationData) || b(),
          routes: e,
      ...
      function E(e, t) {
        return (0, u.aE)({
          ...
          history: (0, u.TM)({ window: null == t ? void 0 : t.window }),
          hydrationData: (null == t ? void 0 : t.hydrationData) || b(),
          routes: e,
          mapRouteProperties: s.UNSAFE_mapRouteProperties,
          dataStrategy: null == t ? void 0 : t.dataStrategy,
      ...
      function b() {
        ...
        return (t && t.errors && (t = l({}, t, { errors: _(t.errors) })), t);
      }
      function _(e) {
        if (!e) return null;
        ...
        for (let [e, a] of t)
          if (a && 'RouteErrorResponse' === a.__type)
            n[e] = new u.VV(a.status, a.statusText, a.data, !0 === a.internal);
      ...
      const C = r.createContext({ isTransitioning: !1 }),
        N = r.createContext(new Map()),
        A = (a || (a = n.t(r, 2))).startTransition,
        x = (o || (o = n.t(i, 2))).flushSync,
        L = (a || (a = n.t(r, 2))).useId;
      function T(e) {
        x ? x(e) : e();
      }
      ...
      function U(e) {
        let { fallbackElement: t, router: n, future: a } = e,
          ...
          [u, l] = r.useState(),
          [c, f] = r.useState({ isTransitioning: !1 }),
          [d, h] = r.useState(),
          [v, m] = r.useState(),
          [p, g] = r.useState(),
          w = r.useRef(new Map()),
        ...
        (r.useLayoutEffect(() => n.subscribe(S), [n, S]),
          r.useEffect(() => {
          ...
          r.useEffect(() => {
            if (d && u && n.window) {
              ...
              (a.finished.finally(() => {
                (h(void 0), m(void 0), l(void 0), f({ isTransitioning: !1 }));
              }),
                m(a));
            }
          }, [R, u, d, n.window]),
          r.useEffect(() => {
            d && u && o.location.key === u.location.key && d.resolve();
          }, [d, v, o.location, u]),
          r.useEffect(() => {
            !c.isTransitioning &&
              p &&
        ...
        return (
          r.useEffect(
            () => (0, s.UNSAFE_logV6DeprecationWarnings)(a, n.future),
            [a, n.future],
          ),
          r.createElement(
            r.Fragment,
            null,
            r.createElement(
              s.UNSAFE_DataRouterContext.Provider,
              { value: _ },
              r.createElement(
                s.UNSAFE_DataRouterStateContext.Provider,
                { value: o },
                r.createElement(
                  N.Provider,
                  { value: w.current },
      ...
      const P = r.memo(k);
      function k(e) {
        let { routes: t, future: n, state: a } = e;
      ...
      function D(e) {
        let { basename: t, children: n, future: a, window: o } = e,
          i = r.useRef();
        null == i.current &&
          (i.current = (0, u.zR)({ window: o, v5Compat: !0 }));
        let l = i.current,
          [c, f] = r.useState({ action: l.action, location: l.location }),
        ...
        return (
          ...
          r.useEffect(() => (0, s.UNSAFE_logV6DeprecationWarnings)(a), [a]),
      ...
      function O(e) {
        let { basename: t, children: n, future: a, window: o } = e,
          i = r.useRef();
        null == i.current &&
          (i.current = (0, u.TM)({ window: o, v5Compat: !0 }));
        let l = i.current,
          [c, f] = r.useState({ action: l.action, location: l.location }),
          { v7_startTransition: d } = a || {},
          h = r.useCallback(
      ...
      function M(e) {
        let { basename: t, children: n, future: a, history: o } = e,
          [i, u] = r.useState({ action: o.action, location: o.location }),
          { v7_startTransition: l } = a || {},
          c = r.useCallback(
            e => {
              l && A ? A(() => u(e)) : u(e);
            },
      ...
      const V =
        ...
        I = r.forwardRef(function (e, t) {
          let n,
            ...
            g = c(e, w),
            { basename: y } = r.useContext(s.UNSAFE_NavigationContext),
            R = !1;
          if ('string' == typeof v && K.test(v) && ((n = v), V))
            try {
          ...
          let S = (0, s.useHref)(v, { relative: o }),
            E = q(v, {
              replace: f,
              state: d,
              target: h,
        ...
        H = r.forwardRef(function (e, t) {
          let {
            ...
            m = c(e, y),
            p = (0, s.useResolvedPath)(d, { relative: m.relative }),
            g = (0, s.useLocation)(),
            w = r.useContext(s.UNSAFE_DataRouterStateContext),
            { navigator: R, basename: S } = r.useContext(
              s.UNSAFE_NavigationContext,
            ),
            E = null != w && se(p) && !0 === h,
            b = R.encodeLocation ? R.encodeLocation(p).pathname : p.pathname,
            _ = g.pathname,
            C =
          ...
          let A,
            x = _ === b || (!i && _.startsWith(b) && '/' === _.charAt(N)),
            L =
              null != C &&
              (C === b ||
                (!i && C.startsWith(b) && '/' === C.charAt(b.length))),
            T = { isActive: x, isPending: L, isTransitioning: E },
            F = x ? n : void 0;
          A =
            'function' == typeof o
              ? o(T)
      ...
      function j(e) {
        ...
        return (oe({ getKey: t, storageKey: n }), null);
      }
      var W, z;
      function Y(e) {
      ...
      function q(e, t) {
        let {
          ...
          c = (0, s.useNavigate)(),
          f = (0, s.useLocation)(),
          d = (0, s.useResolvedPath)(e, { relative: u });
          ...
          t => {
            if (
              ...
              let n =
                void 0 !== a
                  ? a
                  : (0, s.createPath)(f) === (0, s.createPath)(d);
              c(e, {
                replace: n,
                state: o,
                preventScrollReset: i,
      ...
      function G(e) {
        let t = r.useRef(v(e)),
          ...
          u = r.useCallback(
            (e, t) => {
              const a = v('function' == typeof e ? e(o) : e);
              ((n.current = !0), i('?' + a, t));
            },
            [i, o],
          );
      ...
      let Q = 0,
        X = () => '__' + String(++Q) + '__';
      function Z() {
        let { router: e } = Y(W.UseSubmit),
          { basename: t } = r.useContext(s.UNSAFE_NavigationContext),
          n = (0, s.UNSAFE_useRouteId)();
        return r.useCallback(
          function (a, o) {
            (void 0 === o && (o = {}),
              (function () {
            ...
            let {
              ...
              if (h((s = e)) && 'form' === s.tagName.toLowerCase()) {
                ...
                ((a = i ? (0, u.pb)(i, t) : null),
                  (n = e.getAttribute('method') || f),
                  (o = g(e.getAttribute('enctype')) || d),
                  (r = new FormData(e)));
              } else if (
                (function (e) {
      ...
      function $(e, t) {
        let { relative: n } = void 0 === t ? {} : t,
          { basename: a } = r.useContext(s.UNSAFE_NavigationContext),
          o = r.useContext(s.UNSAFE_RouteContext);
        o || (0, u.Oi)(!1);
        let [i] = o.matches.slice(-1),
          c = l({}, (0, s.useResolvedPath)(e || '.', { relative: n })),
          f = (0, s.useLocation)();
        if (null == e) {
          c.search = f.search;
        ...
        return (
          (e && '.' !== e) ||
            ...
            (c.search = c.search
              ...
              : '?index'),
          '/' !== a &&
            (c.pathname = '/' === c.pathname ? a : (0, u.HS)([a, c.pathname])),
          (0, s.createPath)(c)
        );
      }
      function ee(e) {
        ...
        let { key: n } = void 0 === e ? {} : e,
          { router: a } = Y(W.UseFetcher),
          o = J(z.UseFetcher),
          i = r.useContext(N),
          c = r.useContext(s.UNSAFE_RouteContext),
          f =
            null == (t = c.matches[c.matches.length - 1]) ? void 0 : t.route.id;
        (i || (0, u.Oi)(!1), c || (0, u.Oi)(!1), null == f && (0, u.Oi)(!1));
        let d = L ? L() : '',
          [h, v] = r.useState(n || d);
        (n && n !== h ? v(n) : h || v(X()),
          r.useEffect(
        ...
        let m = r.useCallback(
          ...
          g = r.useCallback(
            (e, t) => {
              p(e, l({}, t, { navigate: !1, fetcherKey: h }));
            },
            [h, p],
          ),
          w = r.useMemo(
            () =>
              r.forwardRef((e, t) =>
                r.createElement(
                  B,
                  l({}, e, { navigate: !1, fetcherKey: h, ref: t }),
                ),
              ),
            [h],
          ),
          ...
          R = i.get(h);
        return r.useMemo(
          () => l({ Form: w, submit: g, load: m }, y, { data: R }),
          [w, g, m, y, R],
        );
      }
      function te() {
      ...
      function oe(e) {
        let { getKey: t, storageKey: n } = void 0 === e ? {} : e,
          { router: a } = Y(W.UseScrollRestoration),
          { restoreScrollPosition: o, preventScrollReset: i } = J(
            z.UseScrollRestoration,
          ),
          { basename: c } = r.useContext(s.UNSAFE_NavigationContext),
          f = (0, s.useLocation)(),
          d = (0, s.useMatches)(),
          h = (0, s.useNavigation)();
        (r.useEffect(
            ...
            r.useLayoutEffect(() => {
              let e =
                ...
                n =
                  null == a
                    ? void 0
                    : a.enableScrollRestoration(ae, () => window.scrollY, e);
              return () => n && n();
            }, [a, c, t]),
            r.useLayoutEffect(() => {
              if (!1 !== o)
      ...
      function ie(e) {
        ...
        (r.useEffect(() => {
          'blocked' === a.state &&
            (window.confirm(n) ? setTimeout(a.proceed, 0) : a.reset());
        }, [a, n]),
          r.useEffect(() => {
      ...
      function se(e, t) {
        ...
        null == n && (0, u.Oi)(!1);
        let { basename: a } = Y(W.useViewTransitionState),
          o = (0, s.useResolvedPath)(e, { relative: t.relative });
        if (!n.isTransitioning) return !1;
        let i =
            (0, u.pb)(n.currentLocation.pathname, a) ||
            n.currentLocation.pathname,
          l = (0, u.pb)(n.nextLocation.pathname, a) || n.nextLocation.pathname;
        return (
          null != (0, u.B6)(o.pathname, l) || null != (0, u.B6)(o.pathname, i)
        );
      }
    },
  },
]);
//# sourceMappingURL=8419.b4bd3595.chunk.js.map
