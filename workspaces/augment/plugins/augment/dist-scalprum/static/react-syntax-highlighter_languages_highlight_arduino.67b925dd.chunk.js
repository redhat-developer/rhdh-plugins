      ...
      e.exports = function (e) {
        const n = (function (e) {
            const n = e.COMMENT('//', '$', { contains: [{ begin: /\\\n/ }] }),
              ...
              a = '[a-zA-Z_]\\w*::',
              s = '(' + i + '|' + t(a) + '[a-zA-Z_]\\w*' + t('<[^<>]+>') + ')',
              o = { className: 'keyword', begin: '\\b[a-z\\d_]*_t\\b' },
              l = {
                className: 'string',
                variants: [
                  {
              ...
              d = {
                ...
                contains: [
                  { begin: /\\\n/, relevance: 0 },
                  e.inherit(l, { className: 'meta-string' }),
            ...
            var _;
            const b = [g, d, o, n, e.C_BLOCK_COMMENT_MODE, c, l],
              h = {
                variants: [
                  { begin: /=/, end: /;/ },
                  { begin: /\(/, end: /\)/ },
              ...
              y = {
                ...
                illegal: /[^\w\s\*&:<>.]/,
                contains: [
                  { begin: i, keywords: m, relevance: 0 },
                  { begin: p, returnBegin: !0, contains: [u], relevance: 0 },
                  { begin: /::/, relevance: 0 },
                  { begin: /:/, endsWithParent: !0, contains: [l, c] },
                  {
                    ...
                    contains: [
                      ...
                      o,
                      {
                        ...
                        keywords: m,
                        relevance: 0,
                        contains: ['self', n, e.C_BLOCK_COMMENT_MODE, l, c, o],
                      },
                    ],
                  },
                  o,
            ...
            return {
              ...
              exports: { preprocessor: d, strings: l, keywords: m },
            };
          })(e),
          i = n.keywords;
        return (
          (i.keyword += ' boolean byte word String'),
          (i.literal +=
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_arduino.67b925dd.chunk.js.map
