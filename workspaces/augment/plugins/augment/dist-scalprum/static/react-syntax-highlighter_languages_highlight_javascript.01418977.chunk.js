    ...
    94704(e) {
      ...
      e.exports = function (e) {
        const c = n,
          ...
          l = { $pattern: n, keyword: a, literal: s, built_in: r },
          b = '[0-9](_?[0-9])*',
          g = `\\.(${b})`,
        ...
        return {
          ...
          contains: [
            ...
            },
            {
              ...
              excludeEnd: !0,
              keywords: l,
              contains: ['self', e.inherit(e.TITLE_MODE, { begin: c }), O],
              illegal: /%/,
            },
            { beginKeywords: 'while if switch catch for' },
            {
              ...
              begin:
                ...
                '\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{',
              returnBegin: !0,
              contains: [O, e.inherit(e.TITLE_MODE, { begin: c })],
            },
            {
            ...
            },
            {
              ...
              excludeEnd: !0,
              contains: [e.inherit(e.TITLE_MODE, { begin: c }), 'self', O],
            },
            {
              begin: '(get|set)\\s+(?=' + c + '\\()',
              end: /\{/,
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_javascript.01418977.chunk.js.map
