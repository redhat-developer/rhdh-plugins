/*! For license information please see 3657.dff53eb3.chunk.js.LICENSE.txt */
'use strict';
(self.webpackChunkred_hat_developer_hub_backstage_plugin_augment =
  ...
  [3657, 6038],
  {
    ...
    53657(e, r, t) {
      ...
      var n = t(95478),
        ...
        g = i(function (e) {
          return i(function (r) {
            return (function (e, r) {
              return 'function' == typeof r ? r(e) : (0, a.A)({}, e, r);
            })(e, r);
          });
        }),
        b = function (e) {
          var r = n.useContext(v);
          return (
            e.theme !== r && (r = g(r)(e.theme)),
            n.createElement(v.Provider, { value: r }, e.children)
          );
        };
      function S(e) {
        var r,
          ...
          i = n.forwardRef(function (r, t) {
            var o = n.useContext(v);
            return n.createElement(e, (0, a.A)({ theme: o, ref: t }, r));
          });
        return (
          (i.displayName = 'WithTheme(' + o + ')'),
          (r = i),
          (t = e),
          c()(r, t)
        );
      ...
      var x,
        ...
        E = p(function (e, r, t) {
          var o = e.css;
          'string' == typeof o &&
            void 0 !== r.registered[o] &&
            (o = r.registered[o]);
          var a = e[w],
            i = [o],
            s = '';
          'string' == typeof e.className
            ? (s = (0, u.Rk)(r.registered, i, e.className))
            : null != e.className && (s = e.className + ' ');
          var c = (0, l.J)(i, void 0, n.useContext(v));
          s += r.key + '-' + c.name;
          var f = {};
          for (var m in e)
            _.call(e, m) && 'css' !== m && m !== w && (f[m] = e[m]);
          return (
            (f.className = s),
            t && (f.ref = t),
            n.createElement(
        ...
        $ = function (e, r) {
          var t = arguments;
          if (null == r || !_.call(r, 'css'))
            return n.createElement.apply(void 0, t);
          var o = t.length,
            a = new Array(o);
          ((a[0] = E),
            (a[1] = (function (e, r) {
              var t = {};
              for (var n in r) _.call(r, n) && (t[n] = r[n]);
              return ((t[w] = e), t);
            })(e, r)));
      ...
      ((x = $ || ($ = {})), C || (C = x.JSX || (x.JSX = {})));
      var O = p(function (e, r) {
        var t = e.styles,
          o = (0, l.J)([t], void 0, n.useContext(v)),
          a = n.useRef();
        return (
          (0, f.i)(
            function () {
          ...
          (0, f.i)(
            function () {
              ...
              if (e[1]) e[1] = !1;
                ...
                if (
                  (void 0 !== o.next && (0, u.sk)(r, o.next, !0), t.tags.length)
                ) {
      ...
      var M = function e(r) {
        ...
        T = function (e) {
          ...
          return (
            (0, f.s)(function () {
              for (var e = 0; e < t.length; e++) (0, u.sk)(r, t[e], !1);
            }),
            null
          );
        },
          ...
          var t = [],
            o = function () {
              for (
                ...
                n[o] = arguments[o];
              var a = (0, l.J)(n, r.registered);
              return (t.push(a), (0, u.SF)(r, a, !1), r.key + '-' + a.name);
            },
            a = {
              css: o,
              cx: function () {
              ...
              theme: n.useContext(v),
            },
            i = e.children(a);
          return n.createElement(
            n.Fragment,
            null,
            n.createElement(T, { cache: r, serializedArr: t }),
            i,
          );
        });
    },
    85557(e, r, t) {
      ...
      var n = {
        ...
        l = function (e, r) {
          switch (e) {
            ...
            case 'animationName':
              if ('string' == typeof r)
                return r.replace(i, function (e, r, t) {
                  return ((m = { name: r, styles: t, next: m }), r);
                });
          }
          return 1 === n[e] || s(e) || 'number' != typeof r || 0 === r
            ? r
            : r + 'px';
        };
      function f(e, r, t) {
        ...
        switch (typeof t) {
          ...
          case 'object':
            ...
            if (void 0 !== a.styles) {
              ...
              if (void 0 !== i)
                for (; void 0 !== i; )
                  ((m = { name: i.name, styles: i.styles, next: m }),
                    (i = i.next));
              return a.styles + ';';
            }
            return (function (e, r, t) {
      ...
      function d(e, r, t) {
        ...
        for (var i = 1; i < e.length; i++)
          ((o += f(t, r, e[i])), n && (o += a[i]));
        y.lastIndex = 0;
        for (var s, c = ''; null !== (s = y.exec(o)); ) c += '-' + s[1];
        var u =
          (function (e) {
    ...
    16558(e, r, t) {
      ...
      var o = t(95478),
        a =
          !!(n || (n = t.t(o, 2))).useInsertionEffect &&
          (n || (n = t.t(o, 2))).useInsertionEffect,
        i =
          a ||
          function (e) {
      ...
      function n(e, r, t) {
        ...
        return (
          t.split(' ').forEach(function (t) {
            void 0 !== e[t] ? r.push(e[t] + ';') : t && (n += t + ' ');
          }),
          n
        );
      }
      t.d(r, { Rk: () => n, SF: () => o, sk: () => a });
    ...
    75985(e, r, t) {
      ...
      e.exports = function e(r, t, n) {
        if ('string' != typeof t) {
          ...
          var i = l(t);
          f && (i = i.concat(f(t)));
          for (var s = c(r), p = c(t), v = 0; v < i.length; ++v) {
            var h = i[v];
            if (!(a[h] || (n && n[h]) || (p && p[h]) || (s && s[h]))) {
              var g = m(t, h);
              try {
                u(r, h, g);
              } catch (e) {}
...
//# sourceMappingURL=3657.dff53eb3.chunk.js.map
