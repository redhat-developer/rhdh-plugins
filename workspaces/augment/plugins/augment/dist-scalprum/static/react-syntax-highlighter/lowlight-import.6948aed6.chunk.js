(self.webpackChunkred_hat_developer_hub_backstage_plugin_augment =
  ...
  [8727],
  {
    42878(e, t, n) {
      ...
      ((e.exports = i),
        (i.eval = a(EvalError)),
        (i.range = a(RangeError)),
        (i.reference = a(ReferenceError)),
        (i.syntax = a(SyntaxError)),
        (i.type = a(TypeError)),
        (i.uri = a(URIError)),
        (i.create = a));
    },
            ...
            if (((t = e[o]), u))
              switch (
                ...
                case 'd':
                  ...
                  break;
                case 'f':
                  ((r = String(parseFloat(h()).toFixed(i || 6))),
                    (c += g ? r : r.replace(/^0/, '')));
                  break;
                case 'j':
                  c += JSON.stringify(h());
    ...
    81072(e) {
      ...
      const h = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./,
        ...
        _ = w('/\\*', '\\*/'),
        R = w('#', '$'),
        k = { className: 'number', begin: p, relevance: 0 },
        M = { className: 'number', begin: m, relevance: 0 },
        ...
        A = { className: 'title', begin: d, relevance: 0 },
        S = { className: 'title', begin: f, relevance: 0 },
        j = { begin: '\\.\\s*' + f, relevance: 0 };
      var T = Object.freeze({
        __proto__: null,
            ...
            (t.value = (function (e, t, n) {
              ...
              for (; e.length || t.length; ) {
                ...
                if (
                  ...
                  ('start' === t[0].event ? s.push(t[0].node) : s.pop(),
                    u(t.splice(0, 1)[0]));
              }
      ...
      var ne = (function (e) {
        ...
        function d(e, t, n, r) {
          let i = '',
            a = '';
          'object' == typeof t
            ? ((i = e), (n = t.ignoreIllegals), (a = t.language), (r = void 0))
            : (Y(
                '10.7.0',
        ...
        function f(e, n, r, o) {
            ...
            (null != _.subLanguage
              ? (function () {
                  ...
                  if ('string' == typeof _.subLanguage) {
                    if (!t[_.subLanguage]) return void k.addText(M);
                    ((e = f(_.subLanguage, M, !0, R[_.subLanguage])),
                      (R[_.subLanguage] = e.top));
                  } else e = p(M, _.subLanguage.length ? _.subLanguage : null);
                  (_.relevance > 0 && (O += e.relevance),
                    k.addSublanguage(e.emitter, e.language));
                })()
              : (function () {
                  if (!_.keywords) return void k.addText(M);
                  let e = 0;
                  _.keywordPatternRe.lastIndex = 0;
                  let t = _.keywordPatternRe.exec(M),
                    n = '';
                  for (; t; ) {
                    ...
                    if (r) {
                      const [e, i] = r;
                      if ((k.addText(n), (n = ''), (O += i), e.startsWith('_')))
                        n += t[0];
                      else {
          ...
          function b(e) {
            ...
            a.skip
              ? (M += t)
              : (a.returnEnd || a.excludeEnd || (M += t),
                u(),
                a.excludeEnd && (M = t));
            do {
              (_.className && k.closeNode(),
                _.skip || _.subLanguage || (O += _.relevance),
                (_ = _.parent));
            } while (_ !== i.parent);
            return (
              i.starts &&
          ...
          function E(t, a) {
            ...
            if (
              ...
              if (((M += n.slice(a.index, a.index + 1)), !s)) {
          ...
          try {
            for (_.matcher.considerAll(); ; ) {
              (I++,
                A ? (A = !1) : _.matcher.considerAll(),
                (_.matcher.lastIndex = L));
              const e = _.matcher.exec(n);
              if (!e) break;
              const t = E(n.substring(L, e.index), e);
              L = e.index + t;
            }
            return (
              E(n.substr(L)),
        ...
        function E(e) {
          ...
          if (h(n)) return;
          (k('before:highlightElement', { el: e, language: n }), (t = e));
          const i = t.textContent,
            a = n ? d(i, { language: n, ignoreIllegals: !0 }) : p(i);
          (k('after:highlightElement', { el: e, result: a, text: i }),
            (e.innerHTML = a.value),
            (function (e, t, n) {
              const i = t ? r[t] : n;
          ...
          Object.assign(e, {
            ...
            registerLanguage: function (n, r) {
              ...
              (i.name || (i.name = n),
                ...
                i.aliases && _(i.aliases, { languageName: n }));
            },
    ...
    63341(e, t, n) {
      ...
      ((t.highlight = s),
        (t.highlightAuto = function (e, t) {
          var n,
            ...
            d = g.length,
            f = -1;
          if ((null == h && (h = a), 'string' != typeof e))
            throw i('Expected `string` for value, got `%s`', e);
          for (
            o = { relevance: 0, language: null, value: [] },
              n = { relevance: 0, language: null, value: [] };
            ++f < d;
          )
            ((c = g[f]),
              r.getLanguage(c) &&
                (((l = s(c, e, t)).language = c),
                l.relevance > o.relevance && (o = l),
                l.relevance > n.relevance && ((o = n), (n = l))));
          return (o.language && (n.secondBest = o), n);
        }),
        ...
        (t.registerAlias = function (e, t) {
          var n,
            i = e;
          for (n in (t && ((i = {})[e] = t), i))
            r.registerAliases(i[n], { languageName: n });
        }),
        ...
        (o.prototype.addKeyword = function (e, t) {
          (this.openNode(t), this.addText(e), this.closeNode());
        }),
        (o.prototype.addSublanguage = function (e, t) {
          var n = this.stack,
            r = n[n.length - 1],
            ...
            a = t
              ...
              : i;
          r.children = r.children.concat(a);
        }),
        (o.prototype.openNode = function (e) {
          var t = this.stack,
            n = {
              type: 'element',
              tagName: 'span',
              properties: { className: [this.options.classPrefix + e] },
              children: [],
            };
          (t[t.length - 1].children.push(n), t.push(n));
        }),
        (o.prototype.closeNode = function () {
          this.stack.pop();
        }),
        (o.prototype.closeAllNodes = l),
        (o.prototype.finalize = l),
      ...
      function s(e, t, n) {
        var s,
          ...
          c = (n || {}).prefix;
        if ('string' != typeof e)
          throw i('Expected `string` for name, got `%s`', e);
        if (!r.getLanguage(e))
          throw i('Unknown language: `%s` is not registered', e);
        if ('string' != typeof t)
          throw i('Expected `string` for value, got `%s`', t);
        if (
          (null == c && (c = a),
          r.configure({ __emitter: o, classPrefix: c }),
          (s = r.highlight(t, { language: e, ignoreIllegals: !0 })),
          r.configure(l || {}),
          s.errorRaised)
        )
          throw s.errorRaised;
...
//# sourceMappingURL=lowlight-import.6948aed6.chunk.js.map
