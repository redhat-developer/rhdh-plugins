/*! For license information please see 8690.aae6f680.chunk.js.LICENSE.txt */
'use strict';
    ...
    18690(e, t, r) {
      ...
      (r.r(t),
        r.d(t, {
          ...
          UNSAFE_useRouteId: () => M,
          UNSAFE_useRoutesImpl: () => P,
          createMemoryRouter: () => me,
          createPath: () => o.AO,
      ...
      const l = a.createContext(null),
        ...
        p = a.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
        v = a.createContext(null);
      function h(e, t) {
        let { relative: r } = void 0 === t ? {} : t;
        m() || (0, o.Oi)(!1);
        let { basename: n, navigator: i } = a.useContext(c),
          { hash: l, pathname: u, search: s } = S(e, { relative: r }),
          d = u;
        return (
          '/' !== n && (d = '/' === u ? n : (0, o.HS)([n, u])),
          i.createHref({ pathname: d, search: s, hash: l })
        );
      }
      function m() {
      ...
      function f() {
        return (m() || (0, o.Oi)(!1), a.useContext(d).location);
      }
      function g() {
      ...
      function C() {
        let { isDataRoute: e } = a.useContext(p);
        return e
          ? (function () {
              let { router: e } = A(F.UseNavigateStable),
                t = H(L.UseNavigateStable),
                r = a.useRef(!1);
              return (
                y(() => {
                  r.current = !0;
          ...
          : (function () {
              ...
              let e = a.useContext(l),
                { basename: t, future: r, navigator: n } = a.useContext(c),
                { matches: i } = a.useContext(p),
                { pathname: u } = f(),
                ...
                a.useCallback(
                  function (r, a) {
                    ...
                    (null == e &&
                      '/' !== t &&
                      (i.pathname =
                        '/' === i.pathname ? t : (0, o.HS)([t, i.pathname])),
      ...
      function x(e) {
        ...
        return t ? a.createElement(b.Provider, { value: e }, t) : t;
      }
      function _() {
        let { matches: e } = a.useContext(p),
          t = e[e.length - 1];
        return t ? t.params : {};
      }
      function S(e, t) {
        let { relative: r } = void 0 === t ? {} : t,
          { future: n } = a.useContext(c),
          { matches: i } = a.useContext(p),
          { pathname: l } = f(),
          u = JSON.stringify((0, o.yD)(i, n.v7_relativeSplatPath));
        return a.useMemo(
          () => (0, o.Gh)(e, JSON.parse(u), l, 'path' === r),
          [e, u, l, r],
        );
      }
      function O(e, t) {
      ...
      function P(e, t, r, n) {
        ...
        let { navigator: l } = a.useContext(c),
          { matches: u } = a.useContext(p),
          s = u[u.length - 1],
          v = s ? s.params : {},
          h = (s && s.pathname, s ? s.pathnameBase : '/');
        s && s.route;
        let g,
          E = f();
        if (t) {
        ...
        if ('/' !== h) {
          ...
          b = '/' + C.replace(/^\//, '').split('/').slice(e.length).join('/');
        }
        let R = (0, o.ue)(e, { pathname: b }),
          x = B(
            R &&
              R.map(e =>
                Object.assign({}, e, {
      ...
      const D = a.createElement(k, null);
      ...
      function N(e) {
        ...
        return (
          ...
          a.createElement(p.Provider, { value: t }, n)
        );
      }
      function B(e, t, r, n) {
        var i;
        ...
        return u.reduceRight((e, n, o) => {
          ...
          var h;
          r &&
            ((i = s && n.route.id ? s[n.route.id] : void 0),
            (p = n.route.errorElement || D),
            c &&
              (d < 0 && 0 === o
                ? (K[(h = 'route-fallback')] || (K[h] = !0),
                  (l = !0),
                  (v = null))
                : d === o &&
                  ((l = !0), (v = n.route.hydrateFallbackElement || null))));
          let m = t.concat(u.slice(0, o + 1)),
            f = () => {
              let t;
              return (
                (t = i
      ...
      function M() {
        return H(L.UseRouteId);
      }
      function I() {
        return j(L.UseNavigation).navigation;
      }
      function T() {
        let e = A(F.UseRevalidator),
          t = j(L.UseRevalidator);
        return a.useMemo(
      ...
      function w() {
        let { matches: e, loaderData: t } = j(L.UseMatches);
        return a.useMemo(() => e.map(e => (0, o.ro)(e, t)), [e, t]);
      }
      function z() {
        let e = j(L.UseLoaderData),
          t = H(L.UseLoaderData);
      ...
      function J(e) {
        return j(L.UseRouteLoaderData).loaderData[e];
      }
      function G() {
        let e = j(L.UseActionData),
          t = H(L.UseLoaderData);
      ...
      let q = 0;
      function Y(e) {
        let { router: t, basename: r } = A(F.UseBlocker),
          n = j(L.UseBlocker),
          [l, u] = a.useState(''),
          s = a.useCallback(
            t => {
              ...
              if ('/' === r) return e(t);
              let { currentLocation: n, nextLocation: a, historyAction: l } = t;
              return e({
                currentLocation: i({}, n, {
        ...
        return (
          ...
          l && n.blockers.has(l) ? n.blockers.get(l) : o.G3
        );
      }
      const K = {};
      function Q(e, t) {
      ...
      function $(e) {
        ...
        let d = a.useMemo(
          ...
          p = r.basename || '/',
          v = a.useMemo(
            () => ({ router: r, navigator: d, static: !1, basename: p }),
            [r, d, p],
          );
        return (
          a.useEffect(() => Q(n, r.future), [r, n]),
          a.createElement(
            a.Fragment,
            null,
            a.createElement(
      ...
      function re(e) {
        ...
        m() || (0, o.Oi)(!1);
        let { future: l, static: u } = a.useContext(c),
          { matches: s } = a.useContext(p),
          { pathname: d } = f(),
          v = C(),
          h = (0, o.Gh)(
            t,
            (0, o.yD)(s, l.v7_relativeSplatPath),
            d,
            'path' === i,
          ),
          g = JSON.stringify(h);
        return (
          a.useEffect(
            () => v(JSON.parse(g), { replace: r, state: n, relative: i }),
            [v, g, i, r, n],
          ),
          null
        );
      ...
      function oe(e) {
        ...
        let v = t.replace(/^\/*/, '/'),
          h = a.useMemo(
            () => ({
              ...
              navigator: u,
              static: s,
              future: i({ v7_relativeSplatPath: !1 }, p),
            }),
            [v, p, u, s],
          );
        ...
        return null == b
          ...
          : a.createElement(
              c.Provider,
              { value: h },
              a.createElement(d.Provider, { children: r, value: b }),
            );
      }
      function ie(e) {
      ...
      class ce extends a.Component {
        ...
        render() {
          ...
          if (i === ue.error)
            return a.createElement(s.Provider, { value: n, children: t });
          if (i === ue.success)
            return a.createElement(s.Provider, { value: n, children: e });
          throw n;
        }
      }
      function de(e) {
        ...
        return (
          a.Children.forEach(e, (e, n) => {
            ...
            if (e.type === a.Fragment)
              return void r.push.apply(r, pe(e.props.children, i));
            (e.type !== ae && (0, o.Oi)(!1),
              e.props.index && e.props.children && (0, o.Oi)(!1));
            let l = {
            ...
            (e.props.children && (l.children = pe(e.props.children, i)),
              r.push(l));
          }),
          r
        );
...
//# sourceMappingURL=8690.aae6f680.chunk.js.map
