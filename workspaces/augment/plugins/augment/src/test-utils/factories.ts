...
/**
 * Creates a partial mock of AugmentApi with sensible defaults.
 * Override specific methods by passing them in the `overrides` parameter.
 */
export function createMockApi(
  overrides: Partial<AugmentApi> = {},
): Partial<AugmentApi> {
  return {
...
/**
 * Creates a partial mock of AugmentApi with all admin panel methods.
 ...
 */
export function createAdminMockApi(): Partial<AugmentApi> {
  return {
    getAdminConfig: jest
      .fn()
...
/**
 * Creates a test AugmentStatus with sensible defaults.
 */
export function createMockStatus(
  overrides: Partial<AugmentStatus> = {},
): AugmentStatus {
  return {
    providerId: 'test',
    provider: {
