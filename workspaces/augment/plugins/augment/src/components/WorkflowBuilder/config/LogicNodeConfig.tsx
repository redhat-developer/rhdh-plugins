  ...
  return (
    <>
      <FormControl variant="standard" size="small" fullWidth sx={{ mb: 1.5 }}>
        ...
        <Select
          value={(nodeData.kind as string) || 'if_else'}
          label="Logic Type"
      ...
      <TextField
        variant="standard"
        label="Condition (CEL expression)"
        size="small"
        fullWidth
        multiline
        minRows={2}
        ...
        sx={{ mb: 1.5 }}
        helperText="Common Expression Language (CEL). Reference previous outputs like: triageResult.output_parsed.classification == 'billing'"
        placeholder='result.output_parsed.classification == "billing"'
      />
