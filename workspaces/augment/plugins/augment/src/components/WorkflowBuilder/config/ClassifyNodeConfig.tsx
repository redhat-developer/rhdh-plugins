...
export function ClassifyNodeConfig({ nodeData, update }: NodeConfigProps) {
  const classifications = Array.isArray(nodeData.classifications)
    ? (nodeData.classifications as Array<{
        label: string;
        description: string;
      }>)
    : [];
  ...
  return (
    <>
      ...
      <TextField
        ...
        sx={{ mb: 1.5 }}
        helperText="Optional. By default, auto-generates from classifications."
      />
        ...
        >
          <TextField
            ...
            onChange={e => {
              ...
              update('classifications', updated);
            }}
            sx={{ flex: 1 }}
          />
          <TextField
          ...
          <Button
            ...
            onClick={() =>
              update(
                'classifications',
                classifications.filter((_, j) => j !== i),
              )
            }
            sx={{ minWidth: 28, px: 0.5, height: 40 }}
          >
            X
          </Button>
        </Box>
