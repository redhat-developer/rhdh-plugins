      ...
      >
        ...
        <Box sx={{ px: 3, pt: 3, pb: 1.5 }}>
          ...
          >
            ...
            >
              {t('adminOnboarding.welcomeAdmin')}
            </Typography>
          </Box>
          <Typography
            variant="body2"
          ...
          >
            {t('adminOnboarding.adminAccessMessage')}
          </Typography>
        </Box>
        ...
        <Box sx={{ px: 3, pb: 1.5 }}>
          ...
          >
            ...
            <Box>
              ...
              >
                {t('adminOnboarding.continueToChat')}
              </Typography>
              <Typography
                variant="caption"
                sx={{
              ...
              >
                {t('adminOnboarding.continueToChatDescription')}
              </Typography>
            </Box>
          </Box>
          ...
          >
            ...
            <Box>
              ...
              >
                {t('adminOnboarding.openCommandCenter')}
              </Typography>
              <Typography
                variant="caption"
                sx={{
              ...
              >
                {t('adminOnboarding.openCommandCenterDescription')}
              </Typography>
            </Box>
          </Box>
        </Box>
