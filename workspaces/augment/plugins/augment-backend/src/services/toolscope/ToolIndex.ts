...
export class ToolIndex {
  ...
  filterWithTrace(
    ...
    if (allow) trace.allowTags = [...allow].sort();
    if (deny) trace.denyTags = [...deny].sort();
    ...
    if (allow) backendFilter.allow_tags = [...allow].sort();
    if (deny) backendFilter.deny_tags = [...deny].sort();
