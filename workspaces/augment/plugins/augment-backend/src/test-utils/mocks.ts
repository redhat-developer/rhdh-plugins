...
import type { ResponsesApiClient } from '../providers/llamastack/ResponsesApiClient';
...
/**
 * Creates a mock ResponsesApiClient with `request` and `streamRequest` stubs.
 */
export function createMockClient(): jest.Mocked<
  Pick<ResponsesApiClient, 'request' | 'requestWithRetry' | 'streamRequest'>
> {
