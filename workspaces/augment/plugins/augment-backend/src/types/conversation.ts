...
import type { ResponsesApiOutputEvent } from './responsesApi';
...
export interface ResponsesApiResponse {
  ...
  /** Reasoning configuration used, if any */
  reasoning?: {
    effort?: 'low' | 'medium' | 'high';
    summary?: 'auto' | 'concise' | 'detailed';
    encrypted_content?: string;
  };
  /** Context window truncation strategy used */
