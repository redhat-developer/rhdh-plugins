...
const translationsTranslationJa = createTranslationMessages({
  ...
  messages: {
    'page.title': '翻訳',
    'page.subtitle': '読み込まれた翻訳を管理および表示します',
    'table.title': '読み込まれた翻訳 ({{count}})',
    'table.headers.refId': '参照 ID',
    'table.headers.key': 'キー',
    'table.options.pageSize': '1 ページあたりの項目数',
    'table.options.pageSizeOptions': '{{count}} 件の項目を表示する',
    'export.title': '翻訳',
    'export.downloadButton': 'デフォルトの翻訳 (英語) をダウンロードする',
