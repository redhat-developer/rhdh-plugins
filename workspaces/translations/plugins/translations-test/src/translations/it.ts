...
const quickstartTranslationIt = createTranslationMessages({
  ...
  messages: {
    ...
    'plurals.key_two': 'two',
    'plurals.key_few': 'few',
    'plurals.key_many': 'many',
    'plurals.key_other': 'other',
    ...
    'context.friend_female': 'Una fidanzata',
