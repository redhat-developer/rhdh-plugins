 ...
 * @public
 */
export class ExtensionsPackageProcessor implements CatalogProcessor {
  private readonly validators = [entityKindSchemaValidator(packageJsonSchema)];

  getProcessorName(): string {
    return 'ExtensionsPackageProcessor';
  }
...
/**
 * @public
 * @deprecated Use ExtensionsPackageProcessor instead
 */
export const MarketplacePackageProcessor = ExtensionsPackageProcessor;
