...
export class LocalPackageInstallStatusProcessor implements CatalogProcessor {
  ...
  private isPackageInstalled(
    ...
    versionRange?: string,
  ): ExtensionsPackageInstallStatus | null {
    try {
  ...
  async preProcessEntity(
    ...
    if (isExtensionsPackage(entity)) {
      if (entity.spec?.packageName && !entity.spec.installStatus) {
        ...
        let installStatus: ExtensionsPackageInstallStatus | undefined =
          undefined;
        ...
        if (!installStatus) {
          installStatus = ExtensionsPackageInstallStatus.NotInstalled;
        }
