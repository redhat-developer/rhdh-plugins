...
import { ExtensionsPluginProcessor } from './ExtensionsPluginProcessor';

const testPlugin: ExtensionsPlugin = {
...
describe('ExtensionsPluginProcessor', () => {
  it('should return processor name', () => {
    const processor = new ExtensionsPluginProcessor();
    expect(processor.getProcessorName()).toBe('ExtensionsPluginProcessor');
  });
