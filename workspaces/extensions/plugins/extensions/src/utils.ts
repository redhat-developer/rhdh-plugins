...
export const isPluginInstalled = (
  pluginInstallStatus: ExtensionsPluginInstallStatus | undefined,
) => {
  if (!pluginInstallStatus) {
    return false;
  }
  return (
    pluginInstallStatus === ExtensionsPluginInstallStatus.Installed ||
    pluginInstallStatus === ExtensionsPluginInstallStatus.UpdateAvailable ||
    pluginInstallStatus === ExtensionsPluginInstallStatus.PartiallyInstalled ||
    pluginInstallStatus === ExtensionsPluginInstallStatus.Disabled
  );
};
