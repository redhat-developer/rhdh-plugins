...
const getBadgeOptions = (
  ...
  if (entity.metadata.annotations?.[ExtensionsAnnotation.CERTIFIED_BY]) {
    return {
      ...
      label: 'Certified',
      tooltip: `Certified by ${entity.metadata.annotations[ExtensionsAnnotation.CERTIFIED_BY]}`,
      statusTooltip: `Stable and secured by ${entity.metadata.annotations[ExtensionsAnnotation.CERTIFIED_BY]}`,
    };
  }
