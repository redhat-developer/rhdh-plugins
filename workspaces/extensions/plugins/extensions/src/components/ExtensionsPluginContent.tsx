...
import {
  ...
  mapExtensionsPluginInstallStatusToButton,
...
export const ExtensionsPluginContentSkeleton = () => {
...
export const ExtensionsPluginContent = ({
  plugin,
}: {
  ...
  const isPackage = isExtensionsPackage(plugin);
  ...
  useEffect(() => {
    ...
    if (
      plugin.spec?.installStatus === ExtensionsPluginInstallStatus.Installed ||
  ...
  const pluginActionButton = () => {
    ...
    if (
      ...
      plugin.spec?.installStatus ===
        ExtensionsPluginInstallStatus.UpdateAvailable ||
      plugin.spec?.installStatus === ExtensionsPluginInstallStatus.Disabled
    ) {
      return (
        <>
          <Button
    ...
    return (
      ...
      >
        {mapExtensionsPluginInstallStatusToButton(
          (plugin.spec?.installStatus as ExtensionsPluginInstallStatus) ??
...
export const ExtensionsPluginContentLoader = () => {
  const { t } = useTranslation();
  ...
  if (plugin.data) {
    return <ExtensionsPluginContent plugin={plugin.data} />;
  }
