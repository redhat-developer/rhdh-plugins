...
const facetsKeys = [
  `metadata.annotations.${ExtensionsAnnotation.CERTIFIED_BY}`,
  `metadata.annotations.${ExtensionsAnnotation.PRE_INSTALLED}`,
  'spec.support.level',
];
...
const SupportTypeFilter = () => {
  ...
  const items = useMemo(() => {
    ...
    supportLevelFilters?.forEach(supportLevelFilter => {
      if (
        supportLevelFilter.value === ExtensionsSupportLevel.GENERALLY_AVAILABLE
      ) {
        allSupportTypeItems.push({
        ...
        supportLevelFilter.value === ExtensionsSupportLevel.TECH_PREVIEW
      ) {
        allSupportTypeItems.push({
        ...
        supportLevelFilter.value === ExtensionsSupportLevel.DEV_PREVIEW
      ) {
        allSupportTypeItems.push({
        ...
        supportLevelFilter.value === ExtensionsSupportLevel.COMMUNITY
      ) {
        allSupportTypeItems.push({
