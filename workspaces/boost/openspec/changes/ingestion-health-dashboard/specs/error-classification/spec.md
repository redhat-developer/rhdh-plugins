...
- **THEN** the error is classified as `errorType: "auth"`
...
- **THEN** the error is classified as `errorType: "network"`
...
- **THEN** the error is classified as `errorType: "schema"`
...
- **THEN** the error is classified as `errorType: "rate-limit"`
...
- **THEN** the error is classified as `errorType: "unknown"`
