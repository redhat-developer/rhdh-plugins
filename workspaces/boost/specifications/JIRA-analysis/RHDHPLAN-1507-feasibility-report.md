...
| App-config-driven provider schedule                                                                 | **Available** — `ai-catalog.providers.<id>.schedule`                                                      |
...
| Criterion                                                                      | Feasible without upstream changes? | Assessment                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------ | ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Configurable registry endpoint URLs (no hardcoded SaaS endpoints)              | **YES**                            | Standard app-config pattern: `ai-catalog.providers.<id>.endpoint`. Entity providers read from config. No framework changes                                                                                                          |
...
| Sync interval independently configurable via app-config                                                  | **YES**                            | Standard `ai-catalog.providers.<id>.schedule` pattern                                                                                                                                                                         |
