...
- **RHDHPLAN-1510** produces entities (MCP servers from MCP Registry; ~~models/model servers from RHOAI~~ _(RHDHPLAN-404 scope — RHOAI connector is MCP catalog only)_)
