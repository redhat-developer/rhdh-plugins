...
| Developers browse and see models/model servers from RHOAI       | RHIDP-15166 (Browse page)               | Closed          |
...
- **RHIDP-15314 (RHOAI):** Kubeflow Model Registry API ingestion, RHOAI MCP catalog API ingestion, version normalization, per-source toggle — all backend entity-provider work
