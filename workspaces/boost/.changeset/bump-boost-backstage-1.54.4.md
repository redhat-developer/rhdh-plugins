...
'@red-hat-developer-hub/backstage-plugin-boost-connector-utils': patch
'@red-hat-developer-hub/backstage-plugin-boost-entity-provider-sdk': patch
...
'@red-hat-developer-hub/backstage-plugin-ogx-entity-provider': patch
---

bump workspace to Backstage 1.54.4
