...
import { boostMessages } from './ref';
import boostTranslationDe from './de';
import boostTranslationEs from './es';
import boostTranslationFr from './fr';
import boostTranslationIt from './it';
import boostTranslationJa from './ja';
...
const refKeys = new Set(
  Object.keys(flattenMessages(boostMessages as Record<string, unknown>)),
);
const refKeysSorted = Array.from(refKeys).sort();
const refFlattened = flattenMessages(boostMessages as Record<string, unknown>);

const languageModules = [
  ['de', boostTranslationDe.messages],
  ['es', boostTranslationEs.messages],
  ['fr', boostTranslationFr.messages],
  ['it', boostTranslationIt.messages],
  ['ja', boostTranslationJa.messages],
] as const;
