...
Shared utilities for AI Catalog connector entity providers. Provides:
...
```bash
yarn add @red-hat-developer-hub/backstage-plugin-ai-catalog-connector-utils
```
...
import {
  loadCaBundle,
  createHttpsAgent,
} from '@red-hat-developer-hub/backstage-plugin-ai-catalog-connector-utils';
