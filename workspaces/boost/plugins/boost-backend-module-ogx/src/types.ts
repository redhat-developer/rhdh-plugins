...
/**
 * Configuration for connecting to an OGX endpoint.
 *
 * @internal
 */
export interface OgxConnectionConfig {
  /** Base URL of the OGX API endpoint (e.g., 'http://localhost:8321'). */
  baseUrl: string;
...
/**
 * A model descriptor returned by the OGX models API.
 *
 * @internal
 */
...
/**
 * MCP server configuration for the OGX provider.
 *
 * @internal
 */
export interface OgxMcpServerConfig {
