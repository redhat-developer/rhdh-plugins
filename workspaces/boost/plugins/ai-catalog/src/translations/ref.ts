...
export const aiCatalogMessages = {
  catalog: {
    page: {
      title: 'AI Catalog',
    },
...
/**
 * Translation reference for the AI Catalog plugin.
 * @public
 */
export const aiCatalogTranslationRef = createTranslationRef({
  id: 'plugin.ai-catalog',
  messages: aiCatalogMessages,
});
