...
/**
 * Japanese translation for plugin.homepage.
 * @public
 */
const homepageTranslationJa = createTranslationMessages({
  ...
  messages: {
    ...
    'randomJoke.title': 'ランダムなジョーク',
    'randomJoke.description': 'ランダムなプログラミングジョークを表示します',
    ...
    'onboarding.title': 'Red Hat Developer Hub - オンボーディング',
