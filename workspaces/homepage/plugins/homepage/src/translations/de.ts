...
const homepageTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    'featuredDocs.title': 'Empfohlene Dokumentation',
    ...
    'topVisited.description':
      'Ihre am häufigsten aufgerufenen Entitäten und Dienste',
    'randomJoke.title': 'Zufälliger Witz',
    'randomJoke.description': 'Zeigt einen zufälligen Programmierwitz',
    ...
    'onboarding.title': 'Red Hat Developer Hub – Einführung',
