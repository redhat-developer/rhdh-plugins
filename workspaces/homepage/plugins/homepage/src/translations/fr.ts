...
/**
 * fr translation for plugin.homepage.
 * @public
 */
const homepageTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'featuredDocs.title': 'Documentation en vedette',
    ...
    'randomJoke.title': 'Blague aléatoire',
    'randomJoke.description': 'Affiche une blague de programmation aléatoire',
