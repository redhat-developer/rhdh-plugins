...
start-rhdh-local: clone-rhdh-local generate-env
	...
	podman run -it --rm -w /home -v $(PWD):/home --memory=12g -e NODE_OPTIONS="--max-old-space-size=8192" node:22 bash -c "export NODE_OPTIONS='--max-old-space-size=8192' && yarn install && npx --yes @janus-idp/cli@latest package package-dynamic-plugins --export-to .  && exit"
