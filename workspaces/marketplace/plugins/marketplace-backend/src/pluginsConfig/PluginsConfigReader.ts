...
export class PluginsConfigReader {
  constructor(private readonly dynamicPluginsConfigFile: string | undefined) {}

  parse(): DynamicPackageConfig[] | undefined {
