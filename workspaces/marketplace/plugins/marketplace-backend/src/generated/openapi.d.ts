    ...
    namespace Schemas {
        export interface Plugin {
            ...
            spec?: {
                 ...
                 * NotInstalled
                 */
                installStatus?: "Installed" | "NotInstalled" | "Updatable";
                authors?: {
                    name?: string;
                }[];
            };
...
declare namespace Paths {
    ...
    namespace InstallPlugin {
        ...
        export type RequestBody = Components.Schemas.PluginConfigurationRequest;
        namespace Responses {
            export type $200 = Components.Schemas.PluginConfigurationStatusResponse;
            export interface $400 {
            }
...
export type PluginAuthorizationResponse = Components.Schemas.PluginAuthorizationResponse;
export type PluginConfigurationRequest = Components.Schemas.PluginConfigurationRequest;
export type PluginConfigurationResponse = Components.Schemas.PluginConfigurationResponse;
export type PluginConfigurationStatusResponse = Components.Schemas.PluginConfigurationStatusResponse;
export type PluginDisableRequest = Components.Schemas.PluginDisableRequest;
export type PluginInstallationConfigResponse = Components.Schemas.PluginInstallationConfigResponse;
export type PluginPackageListResponse = Components.Schemas.PluginPackageListResponse;
