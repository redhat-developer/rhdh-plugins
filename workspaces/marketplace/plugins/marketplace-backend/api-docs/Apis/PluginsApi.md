...
|Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **namespace** | **String**| Plugin namespace | [default to null] |
| **name** | **String**| Plugin name | [default to null] |

### Return type

[**List**](../Models/PluginPackage.md)
...
# **installPlugin**
> InstallPluginConfigurationStatusResponse installPlugin(namespace, name, InstallPluginConfigurationRequest)
...
| **namespace** | **String**| Plugin namespace | [default to null] |
| **name** | **String**| Plugin name | [default to null] |
| **InstallPluginConfigurationRequest** | [**InstallPluginConfigurationRequest**](../Models/InstallPluginConfigurationRequest.md)|  | |
