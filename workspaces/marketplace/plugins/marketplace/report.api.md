...
readonly "plugin.category": string;
...
readonly "plugin.entryName": string;
readonly "plugin.bySomeone": string;
...
readonly "package.category": string;
readonly "package.entryName": string;
readonly "package.bySomeone": string;
...
readonly "collection.entryName": string;
readonly "collection.featured": string;
...
readonly "collection.featuredTitle": string;
readonly "collection.featuredDescription": string;
