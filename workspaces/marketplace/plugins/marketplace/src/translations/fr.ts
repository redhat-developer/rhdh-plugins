...
const marketplaceTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'alert.extensionsExample':
      "Pour l'activer, ajoutez ou modifiez la configuration des extensions dans votre fichier **app-config.yaml**.",
    ...
    'installedPackages.table.tooltips.installationDisabled':
      "Le paquet ne peut pas être géré car l'installation de plugins est désactivée. Pour l'activer, mettez à jour votre configuration d'extensions dans votre fichier app-config.yaml.",
