...
const marketplaceTranslationIt = createTranslationMessages({
  ...
  messages: {
    ...
    'installedPackages.table.tooltips.installationDisabled':
      "Il pacchetto non può essere gestito perché l'installazione dei plugin è disabilitata. Per abilitarla, aggiorna la configurazione delle tue estensioni nel tuo file app-config.yaml.",
