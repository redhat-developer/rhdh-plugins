...
const marketplaceTranslationEs = createTranslationMessages({
  ...
  messages: {
    ...
    'alert.extensionsExample':
      'Para habilitarlo, agregue o modifique la configuración de extensiones en su archivo **app-config.yaml**.',
    ...
    'installedPackages.table.tooltips.installationDisabled':
      'El paquete no puede ser gestionado porque la instalación de plugins está deshabilitada. Para habilitarlo, actualiza tu configuración de extensiones en tu archivo app-config.yaml.',
