...
const marketplaceTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    'installedPackages.table.tooltips.installationDisabled':
      'Das Paket kann nicht verwaltet werden, da die Plugin-Installation deaktiviert ist. Um es zu aktivieren, aktualisieren Sie Ihre Erweiterungskonfiguration in Ihrer app-config.yaml-Datei.',
