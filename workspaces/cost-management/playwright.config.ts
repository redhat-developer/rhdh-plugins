...
/**
 * Two-tier Playwright setup (same pattern as workspaces/dcm):
 * - chromium: merge-gate safe — runs app.test.ts against local yarn start
 * - live: downstream E2E — activated when PLAYWRIGHT_URL points at a deployed RHDH
 */
export default defineConfig({
  ...
  projects: [
    ...
    // Downstream E2E only: requires a deployed RHDH + cost-management environment.
