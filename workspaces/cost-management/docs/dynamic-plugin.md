...
4. Add the following configuration to each one of the objects mentioned above respectively
   ...
   - package: oci://quay.io/redhat-resource-optimization/dynamic-plugins:2.4.0!red-hat-developer-hub-plugin-cost-management
     disabled: false
     pluginConfig:
       dynamicPlugins:
         frontend:
           red-hat-developer-hub.plugin-cost-management:
             ...
             menuItems:
               ...
               cost-management.openshift:
                 parent: cost-management
                 priority: 20
   - package: oci://quay.io/redhat-resource-optimization/dynamic-plugins:2.4.0!red-hat-developer-hub-plugin-cost-management-backend
     disabled: false
     pluginConfig:
       costManagement:
