...
4. Add the following configuration to each one of the objects mentioned above respectively
   ...
   - package: oci://quay.io/cost-management/dynamic-plugins:1.2.0!red-hat-developer-hub-plugin-cost-management
      disabled: false
      pluginConfig:
        dynamicPlugins:
          frontend:
              ...
              dynamicRoutes:
                - path: /cost-management
                  ...
                  menuItem:
                    ...
                    text: Optimizations
    - package: oci://quay.io/cost-management/dynamic-plugins:1.2.0!red-hat-developer-hub-plugin-cost-management-backend
      disabled: false
      pluginConfig:
        proxy:
          endpoints:
