...
1. Add the `ResourceOptimizationPage` extension to your `App.tsx` routes
   ...
   - `/cost-management` — Optimizations list
   - `/cost-management/ocp` — OpenShift cost management
   - `/cost-management/:id` — Optimization breakdown
...
1. Add a link to the Cost Management page in the side bar
   ...
   + import { ResourceOptimizationIconOutlined } from '@red-hat-developer-hub/plugin-cost-management';
