...
const bulkImportTranslationEs = createTranslationMessages({
  ...
  messages: {
    ...
    // Pull request
    'pullRequest.title': 'Agregar archivo de configuración catalog-info.yaml',
    'pullRequest.description':
      'Este pull request agrega un **archivo de metadatos de entidad Backstage**\na este repositorio para que el componente pueda\nser agregado al [catálogo de software]({{catalogUrl}}).\nDespués de que este pull request sea fusionado, el componente estará disponible.\nPara más información, lee una [descripción general del catálogo de software Backstage](https://backstage.io/docs/features/software-catalog/).\nVe el trabajo de importación en tu aplicación [aquí]({{importJobUrl}}).',
    ...
    'previewFile.pullRequest.useCodeOwnersFile':
      'Usar archivo <em>CODEOWNERS</em> como propietario de entidad',
