...
const bulkImportTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    // Pull request
    'pullRequest.title': 'catalog-info.yaml Konfigurationsdatei hinzufügen',
    'pullRequest.description':
      'Dieser Pull-Request fügt eine **Backstage Entity-Metadatendatei**\nzu diesem Repository hinzu, damit die Komponente\nzum [Software-Katalog]({{catalogUrl}}) hinzugefügt werden kann.\nNachdem dieser Pull-Request zusammengeführt wurde, wird die Komponente verfügbar.\nWeitere Informationen finden Sie in einer [Übersicht über den Backstage Software-Katalog](https://backstage.io/docs/features/software-catalog/).\nSehen Sie sich den Import-Job in Ihrer App [hier]({{importJobUrl}}) an.',
    ...
    'previewFile.pullRequest.useCodeOwnersFile':
      'Verwende <em>CODEOWNERS</em>-Datei als Entitätsbesitzer',
