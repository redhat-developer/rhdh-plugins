...
/**
 * Keycloak OIDC provider factory with RHDH-specific sign-in resolvers.
 *
 * This factory extends the standard Backstage OIDC provider with additional
 * resolvers for Keycloak and LDAP authentication.
 *
 * Default sign in resolver: oidcSubClaimMatchingKeycloakUserId.
 * Users can override this in app-config.yaml by specifying a different resolver.
 *
 * @public
 */
export const keycloakProviderFactory = createOAuthProviderFactory({
