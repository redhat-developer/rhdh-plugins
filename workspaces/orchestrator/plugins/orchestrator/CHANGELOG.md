...
- 48c4f69: Fix workflow instance page layout overlap when `cardHeightMode` is set to `content`.
...
- Updated dependencies [309547d]
  ...
  - @red-hat-developer-hub/backstage-plugin-orchestrator-form-react@2.6.2
...
- Updated dependencies [b7f8a3c]
  ...
  - @red-hat-developer-hub/backstage-plugin-orchestrator-form-react@2.6.1
...
- Updated dependencies [3648a62]
  ...
  - @red-hat-developer-hub/backstage-plugin-orchestrator-form-react@2.6.0
