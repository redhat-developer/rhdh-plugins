...
const orchestratorTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    'run.logs.title': 'Workflow-Protokolle für {{processName}}',
    ...
    'run.status.aborted': 'Die Ausführung wurde vor {{time}} abgebrochen.',
    ...
    'table.actions.viewRunVariables': 'Laufzeitvariablen anzeigen',
    'table.filters.started': 'Begonnen',
    'table.filters.entity': 'Entity',
    'table.filters.runBy': 'Ausgeführt von',
    ...
    'table.filters.placeholder': 'Filter',
    'table.filters.clearAll': 'Alle löschen',
    ...
    'table.headers.runsLastMonth': 'Ausführungen (letzter Monat)',
    ...
    'table.headers.runBy': 'Ausgeführt von',
