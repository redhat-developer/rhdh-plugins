...
*DefaultApi* | [**getWorkflowLogById**](Apis/DefaultApi.md#getworkflowlogbyid) | **GET** /v2/workflows/instances/{instanceId}/logs | Returns the log for a given workflow ID. |
