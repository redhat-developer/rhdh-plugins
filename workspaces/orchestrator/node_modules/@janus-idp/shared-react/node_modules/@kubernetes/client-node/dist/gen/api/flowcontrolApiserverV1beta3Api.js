...
exports.FlowcontrolApiserverV1beta3Api = exports.FlowcontrolApiserverV1beta3ApiApiKeys = void 0;
...
// ===============================================
var FlowcontrolApiserverV1beta3ApiApiKeys;
(function (FlowcontrolApiserverV1beta3ApiApiKeys) {
    FlowcontrolApiserverV1beta3ApiApiKeys[FlowcontrolApiserverV1beta3ApiApiKeys["BearerToken"] = 0] = "BearerToken";
})(FlowcontrolApiserverV1beta3ApiApiKeys || (exports.FlowcontrolApiserverV1beta3ApiApiKeys = FlowcontrolApiserverV1beta3ApiApiKeys = {}));
class FlowcontrolApiserverV1beta3Api {
    ...
    setApiKey(key, value) {
        this.authentications[FlowcontrolApiserverV1beta3ApiApiKeys[key]].apiKey = value;
    }
    ...
    async createFlowSchema(body, pretty, dryRun, fieldManager, fieldValidation, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas';
        ...
        let localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(body, "V1beta3FlowSchema")
        };
                ...
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1beta3FlowSchema");
    ...
    async createPriorityLevelConfiguration(body, pretty, dryRun, fieldManager, fieldValidation, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(body, "V1beta3PriorityLevelConfiguration")
        };
        let authenticationPromise = Promise.resolve();
        if (this.authentications.BearerToken.apiKey) {
            authenticationPromise = authenticationPromise.then(() => this.authentications.BearerToken.applyToRequest(localVarRequestOptions));
            ...
            return new Promise((resolve, reject) => {
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1beta3PriorityLevelConfiguration");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new apis_1.HttpError(response, body, response.statusCode));
     ...
     * @param body
     */
    async deleteCollectionFlowSchema(pretty, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, sendInitialEvents, timeoutSeconds, body, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
     ...
     * @param body
     */
    async deleteCollectionPriorityLevelConfiguration(pretty, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, sendInitialEvents, timeoutSeconds, body, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
    ...
    async deleteFlowSchema(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}'
    ...
    async deletePriorityLevelConfiguration(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
    ...
    async getAPIResources(options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
        // give precedence to 'application/json'
     ...
     */
    async listFlowSchema(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, timeoutSeconds, watch, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            ...
            return new Promise((resolve, reject) => {
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1beta3FlowSchemaList");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new apis_1.HttpError(response, body, response.statusCode));
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    async listPriorityLevelConfiguration(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, timeoutSeconds, watch, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf', 'application/json;stream=watch', 'application/vnd.kubernetes.protobuf;stream=watch'];
            ...
            return new Promise((resolve, reject) => {
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1beta3PriorityLevelConfigurationList");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    async patchFlowSchemaStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
    ...
    async patchPriorityLevelConfigurationStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
...
exports.FlowcontrolApiserverV1beta3Api = FlowcontrolApiserverV1beta3Api;
//# sourceMappingURL=flowcontrolApiserverV1beta3Api.js.map