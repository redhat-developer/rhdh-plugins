...
import { V1beta1SelfSubjectReview } from '../model/v1beta1SelfSubjectReview';
...
export declare class AuthenticationV1beta1Api {
     ...
     */
    createSelfSubjectReview(body: V1beta1SelfSubjectReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
