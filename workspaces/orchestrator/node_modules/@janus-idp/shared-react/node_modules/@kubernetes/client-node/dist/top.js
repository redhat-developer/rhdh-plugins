...
exports.PodStatus = exports.ContainerStatus = exports.NodeStatus = exports.CurrentResourceUsage = exports.ResourceUsage = void 0;
...
async function topNodes(api) {
    ...
    for (const node of nodes.body.items) {
        ...
        pods = pods.filter((pod) => { var _a; return ((_a = pod.status) === null || _a === void 0 ? void 0 : _a.phase) === 'Running'; });
        pods.forEach((pod) => {
...
async function topPods(api, metrics, namespace) {
    ...
    for (const pod of podList.items) {
        ...
        pod.spec.containers.forEach((container) => {
            ...
            podRequestsMem = (0, util_1.add)(podRequestsMem, containerMemTotal.request);
