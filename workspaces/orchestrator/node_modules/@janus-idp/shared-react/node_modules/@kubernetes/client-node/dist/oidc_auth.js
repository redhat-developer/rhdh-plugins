...
const oidc = tslib_1.__importStar(require("openid-client"));
...
class OpenIDConnectAuth {
    ...
    async getClient(user) {
        ...
        const configuration = await oidc.discovery(user.authProvider.config['idp-issuer-url'], user.authProvider.config['client-id'], metadata);
