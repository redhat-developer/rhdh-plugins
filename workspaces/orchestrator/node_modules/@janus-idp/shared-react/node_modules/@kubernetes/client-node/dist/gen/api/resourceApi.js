...
exports.ResourceApi = exports.ResourceApiApiKeys = void 0;
...
// ===============================================
var ResourceApiApiKeys;
(function (ResourceApiApiKeys) {
    ResourceApiApiKeys[ResourceApiApiKeys["BearerToken"] = 0] = "BearerToken";
})(ResourceApiApiKeys || (exports.ResourceApiApiKeys = ResourceApiApiKeys = {}));
class ResourceApi {
    ...
    setApiKey(key, value) {
        this.authentications[ResourceApiApiKeys[key]].apiKey = value;
    }
    ...
    async getAPIGroup(options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/resource.k8s.io/';
