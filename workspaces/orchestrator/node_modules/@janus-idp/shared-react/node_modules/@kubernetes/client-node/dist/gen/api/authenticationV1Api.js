...
})(AuthenticationV1ApiApiKeys || (exports.AuthenticationV1ApiApiKeys = AuthenticationV1ApiApiKeys = {}));
class AuthenticationV1Api {
    ...
    async createSelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty, options = { headers: {} }) {
        ...
        let localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(body, "V1SelfSubjectReview")
        };
                ...
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1SelfSubjectReview");
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed. Defaults to \&#39;false\&#39; unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
     */
    async createTokenReview(body, dryRun, fieldManager, fieldValidation, pretty, options = { headers: {} }) {
