...
exports.Config = exports.KubeConfig = void 0;
...
const oidc_auth_delayed_1 = require("./oidc_auth_delayed");
...
class KubeConfig {
    ...
    async applyToRequest(opts) {
        ...
        if (cluster && cluster.tlsServerName) {
            opts.agentOptions = { servername: cluster.tlsServerName };
        }
    }
    ...
    async applyAuthorizationHeader(opts) {
        ...
        const authenticator = this.authenticators.find((elt) => {
