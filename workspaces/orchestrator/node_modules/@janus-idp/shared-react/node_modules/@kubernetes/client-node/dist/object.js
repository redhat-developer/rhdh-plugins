...
exports.KubernetesObjectApi = exports.KubernetesEventType = void 0;
 ...
 */
var KubernetesEventType;
(function (KubernetesEventType) {
    KubernetesEventType["ADDED"] = "ADDED";
    KubernetesEventType["MODIFIED"] = "MODIFIED";
    KubernetesEventType["DELETED"] = "DELETED";
    KubernetesEventType["BOOKMARK"] = "BOOKMARK";
    KubernetesEventType["ERROR"] = "ERROR";
})(KubernetesEventType || (exports.KubernetesEventType = KubernetesEventType = {}));
/**
...
class KubernetesObjectApi extends api_1.ApisApi {
    ...
    static makeApiClient(kc) {
        ...
        client.watcher = new watch_1.Watch(kc);
        return client;
    }
    /**
    ...
    async create(spec, pretty, dryRun, fieldManager, options = { headers: {} }) {
        ...
        if (pretty !== undefined) {
            localVarQueryParameters.pretty = serializer_1.default.serialize(pretty, 'string');
        }
        if (dryRun !== undefined) {
            localVarQueryParameters.dryRun = serializer_1.default.serialize(dryRun, 'string');
        }
        if (fieldManager !== undefined) {
            localVarQueryParameters.fieldManager = serializer_1.default.serialize(fieldManager, 'string');
        }
        const localVarRequestOptions = {
            ...
            json: true,
            body: serializer_1.default.serialize(spec, 'KubernetesObject'),
        };
    ...
    async delete(spec, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, options = { headers: {} }) {
        ...
        if (gracePeriodSeconds !== undefined) {
            localVarQueryParameters.gracePeriodSeconds = serializer_1.default.serialize(gracePeriodSeconds, 'number');
        }
        if (orphanDependents !== undefined) {
            localVarQueryParameters.orphanDependents = serializer_1.default.serialize(orphanDependents, 'boolean');
        }
        if (propagationPolicy !== undefined) {
            localVarQueryParameters.propagationPolicy = serializer_1.default.serialize(propagationPolicy, 'string');
        }
        const localVarRequestOptions = {
            method: 'DELETE',
            qs: localVarQueryParameters,
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: serializer_1.default.serialize(body, 'V1DeleteOptions'),
        };
    ...
    async patch(spec, pretty, dryRun, fieldManager, force, options = { headers: {} }) {
        ...
        if (force !== undefined) {
            localVarQueryParameters.force = serializer_1.default.serialize(force, 'boolean');
        }
        const localVarRequestOptions = {
            method: 'PATCH',
            qs: localVarQueryParameters,
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: serializer_1.default.serialize(spec, 'object'),
        };
        return this.requestPromise(localVarRequestOptions);
    }
    /**
    ...
    async read(spec, pretty, exact, exportt, options = { headers: {} }) {
        ...
        if (exact !== undefined) {
            localVarQueryParameters.exact = serializer_1.default.serialize(exact, 'boolean');
        }
        if (exportt !== undefined) {
            localVarQueryParameters.export = serializer_1.default.serialize(exportt, 'boolean');
        }
        const localVarRequestOptions = {
            method: 'GET',
            qs: localVarQueryParameters,
    ...
    async list(apiVersion, kind, namespace, pretty, exact, exportt, fieldSelector, labelSelector, limit, continueToken, options = { headers: {} }) {
        ...
        if (fieldSelector !== undefined) {
            localVarQueryParameters.fieldSelector = serializer_1.default.serialize(fieldSelector, 'string');
        }
        if (labelSelector !== undefined) {
            localVarQueryParameters.labelSelector = serializer_1.default.serialize(labelSelector, 'string');
        }
        if (limit !== undefined) {
            localVarQueryParameters.limit = serializer_1.default.serialize(limit, 'number');
        }
        if (continueToken !== undefined) {
            localVarQueryParameters.continue = serializer_1.default.serialize(continueToken, 'string');
        }
        const localVarRequestOptions = {
            method: 'GET',
            qs: localVarQueryParameters,
     ...
     */
    async watch({ resource, options = {}, callback, done, }) {
        if (!this.watcher) {
            throw new Error('Watcher not initialized');
        }
        const resourcePath = new URL(await this.specUriPath({
        ...
        const cb = (phase, apiObj, watchObj) => {
            const obj = serializer_1.default.deserialize(apiObj, type);
            callback(phase, obj, watchObj
                ? {
                    ...watchObj,
                    object: obj,
                }
        ...
        const res = await this.watcher.watch(resourcePath, options, 
     ...
     */
    async requestPromise(requestOptions, type) {
        ...
        return new Promise((resolve, reject) => {
            request(requestOptions, async (error, response, body) => {
                if (error) {
                    ...
                    body = serializer_1.default.deserialize(body, type);
