 ...
 */
export declare enum KubernetesEventType {
    ADDED = "ADDED",
    MODIFIED = "MODIFIED",
    DELETED = "DELETED",
    BOOKMARK = "BOOKMARK",
...
export type WatchCallback<T extends KubernetesObject | KubernetesObject> = (phase: KubernetesEventType, apiObj: T, watchObj?: WatchObject<T>) => void;
...
export declare class KubernetesObjectApi extends ApisApi {
     ...
     */
    watch<T extends KubernetesObject | KubernetesObject>({ resource, options, callback, done, }: {
        resource: {
            apiVersion: string;
            kind: string;
            namespace?: string;
