...
exports.FlowcontrolApiserverV1Api = exports.FlowcontrolApiserverV1ApiApiKeys = void 0;
...
// ===============================================
var FlowcontrolApiserverV1ApiApiKeys;
(function (FlowcontrolApiserverV1ApiApiKeys) {
    FlowcontrolApiserverV1ApiApiKeys[FlowcontrolApiserverV1ApiApiKeys["BearerToken"] = 0] = "BearerToken";
})(FlowcontrolApiserverV1ApiApiKeys || (exports.FlowcontrolApiserverV1ApiApiKeys = FlowcontrolApiserverV1ApiApiKeys = {}));
class FlowcontrolApiserverV1Api {
    ...
    setApiKey(key, value) {
        this.authentications[FlowcontrolApiserverV1ApiApiKeys[key]].apiKey = value;
    }
    ...
    async createFlowSchema(body, pretty, dryRun, fieldManager, fieldValidation, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1/flowschemas';
        ...
        let localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(body, "V1FlowSchema")
        };
                ...
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1FlowSchema");
    ...
    async createPriorityLevelConfiguration(body, pretty, dryRun, fieldManager, fieldValidation, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(body, "V1PriorityLevelConfiguration")
        };
        let authenticationPromise = Promise.resolve();
        if (this.authentications.BearerToken.apiKey) {
            authenticationPromise = authenticationPromise.then(() => this.authentications.BearerToken.applyToRequest(localVarRequestOptions));
            ...
            return new Promise((resolve, reject) => {
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1PriorityLevelConfiguration");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    async deleteFlowSchema(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1/flowschemas/{name}'
    ...
    async deletePriorityLevelConfiguration(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
    ...
    async getAPIResources(options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1/';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
        // give precedence to 'application/json'
            ...
            return new Promise((resolve, reject) => {
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1FlowSchemaList");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new apis_1.HttpError(response, body, response.statusCode));
            ...
            return new Promise((resolve, reject) => {
                (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = models_1.ObjectSerializer.deserialize(body, "V1PriorityLevelConfigurationList");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    async patchFlowSchemaStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1/flowschemas/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
    ...
    async patchPriorityLevelConfigurationStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force, options = { headers: {} }) {
        const localVarPath = this.basePath + '/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}/status'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
...
exports.FlowcontrolApiserverV1Api = FlowcontrolApiserverV1Api;
//# sourceMappingURL=flowcontrolApiserverV1Api.js.map