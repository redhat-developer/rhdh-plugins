...
declare namespace Models {
     ...
     * @public
     */
    interface Committer extends ModelObject {
        /**
     ...
     * @public
     */
    type WorkspaceForkingModeEnum = (typeof WorkspaceForkingModeEnum)[keyof typeof WorkspaceForkingModeEnum];
    /**
     * @public
     */
...
declare namespace Events {
    ...
    /** @public */
    interface RepoUpdatedEvent extends RepoEvent {
        changes: RepoChanges;
    }
    /** @public */
    interface RepoChanges {
        ...
        links?: RepoChange<Pick<Models.RepositoryLinks, 'avatar' | 'html' | 'self'>>;
        name?: RepoChange<string>;
        website?: RepoChange<string>;
    }
    /** @public */
    interface RepoChange<T> {
        new: T;
        old: T;
    }
    /** @public */
