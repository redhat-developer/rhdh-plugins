...
function useGenerateDescription(annotations) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    " ",
    isSingular ? "annotation" : "annotations",
    " to your component if you want to enable this tool."
  ] });
}
  ...
  return /* @__PURE__ */ jsx(
    EmptyState,
    {
      ...
      action: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(Typography, { variant: "body1", children: t("emptyState.missingAnnotation.actionTitle") }),
        ...
        /* @__PURE__ */ jsx(Button, { color: "primary", component: Link, to: url, children: t("emptyState.missingAnnotation.readMore") })
      ] })
    }
  );
}
