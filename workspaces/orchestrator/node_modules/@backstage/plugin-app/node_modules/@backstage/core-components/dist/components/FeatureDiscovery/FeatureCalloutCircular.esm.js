...
function FeatureCalloutCircular(props) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Box, { className: classes.featureWrapper, ...{ ref: wrapperRef }, children }),
    createPortal(
      /* @__PURE__ */ jsx(Box, { className: classes.backdrop, children: /* @__PURE__ */ jsx(ClickAwayListener, { onClickAway: hide, children: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
          Box,
          {
            ...
            role: "button",
            tabIndex: 0,
            children: /* @__PURE__ */ jsx(Box, { className: classes.pulseCircle })
          }
        ),
        /* @__PURE__ */ jsxs(
          Box,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Typography, { variant: "h2", paragraph: true, children: title }),
