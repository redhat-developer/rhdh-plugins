 ...
 * @alpha
 */
declare const createScaffolderTaskConditionalDecision: (permission: _backstage_plugin_permission_common.ResourcePermission<"scaffolder-task">, conditions: _backstage_plugin_permission_common.PermissionCriteria<_backstage_plugin_permission_common.PermissionCondition<"scaffolder-task">>) => _backstage_plugin_permission_common.ConditionalPolicyDecision;
/**
 * These conditions are used when creating conditional decisions for scaffolder
 ...
 * @alpha
 */
declare const scaffolderTaskConditions: _backstage_plugin_permission_node.Conditions<{
    isTaskOwner: _backstage_plugin_permission_node.PermissionRule<_backstage_plugin_scaffolder_node.SerializedTask, _backstage_plugin_scaffolder_node.TaskFilter, "scaffolder-task", {
        createdBy: string[];
    }>;
}>;

export { createScaffolderActionConditionalDecision, createScaffolderTaskConditionalDecision, createScaffolderTemplateConditionalDecision, scaffolderActionConditions, scaffolderTaskConditions, scaffolderTemplateConditions };
