 ...
 * @public
 */
type EntityFilterQuery = Record<string, string | symbol | (string | symbol)[]>[] | Record<string, string | symbol | (string | symbol)[]>;
/**
 ...
 * @public
 */
type QueryEntitiesCursorRequest = {
    fields?: string[];
    limit?: number;
    cursor: string;
};
 ...
 * @public
 */
type StreamEntitiesRequest = Omit<QueryEntitiesInitialRequest, 'limit' | 'offset'> & {
    /**
...
interface CatalogApi {
     ...
     * @param options - Additional options
     */
    streamEntities(request?: StreamEntitiesRequest, options?: CatalogRequestOptions): AsyncIterable<Entity[]>;
}
