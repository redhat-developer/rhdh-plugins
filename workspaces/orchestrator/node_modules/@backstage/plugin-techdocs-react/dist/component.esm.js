...
const TechDocsShadowDom = (props) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(StylesProvider, { jss, sheetsManager: /* @__PURE__ */ new Map(), children: [
    /* @__PURE__ */ jsx("div", { ref, "data-testid": "techdocs-native-shadowroot" }),
    children
  ] }) });
};
