...
/** @public */
declare function CatalogAutocomplete<T, Multiple extends boolean | undefined = undefined, DisableClearable extends boolean | undefined = undefined, FreeSolo extends boolean | undefined = undefined>(props: CatalogAutocompleteProps<T, Multiple, DisableClearable, FreeSolo>): react_jsx_runtime.JSX.Element;
...
/** @public */
declare const EntityOwnerPicker: (props?: EntityOwnerPickerProps) => react_jsx_runtime.JSX.Element | null;
...
/** @public */
declare const DefaultFilters: (props: DefaultFiltersProps) => react_jsx_runtime.JSX.Element;
...
/** @public */
declare const EntityKindPicker: (props: EntityKindPickerProps) => react_jsx_runtime.JSX.Element | null;
 ...
 * @public
 */
declare function EntityRefLinks<TRef extends string | CompoundEntityRef | Entity>(props: EntityRefLinksProps<TRef>): react_jsx_runtime.JSX.Element;
 ...
 * @public
 */
declare const EntityPeekAheadPopover: (props: EntityPeekAheadPopoverProps) => react_jsx_runtime.JSX.Element;
 ...
 * @public
 */
declare const EntitySearchBar: () => react_jsx_runtime.JSX.Element;
...
declare const EntityTable: {
    <T extends Entity>(props: EntityTableProps<T>): react_jsx_runtime.JSX.Element;
    columns: Readonly<{
...
/** @public */
declare const EntityTagPicker: (props: EntityTagPickerProps) => react_jsx_runtime.JSX.Element;
...
/** @public */
declare const EntityTypePicker: (props: EntityTypePickerProps) => react_jsx_runtime.JSX.Element | null;
 ...
 * @public
 */
declare const FavoriteEntity: (props: FavoriteEntityProps) => react_jsx_runtime.JSX.Element;
...
/** @public */
declare const UnregisterEntityDialog: (props: UnregisterEntityDialogProps) => react_jsx_runtime.JSX.Element;
...
/** @public */
declare const UserListPicker: (props: UserListPickerProps) => react_jsx_runtime.JSX.Element | null;

/** @public */
type CatalogReactEntityProcessingStatusPickerClassKey = 'input';
/** @public */
declare const EntityProcessingStatusPicker: () => react_jsx_runtime.JSX.Element;
...
/** @public */
declare const EntityNamespacePicker: (props: EntityNamespacePickerProps) => react_jsx_runtime.JSX.Element;
 ...
 * @public
 */
declare class EntityOrderFilter implements EntityFilter {
 ...
 * @public
 */
declare const EntityListProvider: <EntityFilters extends DefaultEntityFilters>(props: EntityListProviderProps) => react_jsx_runtime.JSX.Element;
/**
...
/** @public */
declare function EntityAutocompletePicker<T extends DefaultEntityFilters = DefaultEntityFilters, Name extends AllowedEntityFilters<T> = AllowedEntityFilters<T>>(props: EntityAutocompletePickerProps<T, Name>): react_jsx_runtime.JSX.Element | null;
 ...
 * @public
 */
declare const AsyncEntityProvider: (props: AsyncEntityProviderProps) => react_jsx_runtime.JSX.Element;
/**
 ...
 * @public
 */
declare const EntityProvider: (props: EntityProviderProps) => react_jsx_runtime.JSX.Element;
/**
