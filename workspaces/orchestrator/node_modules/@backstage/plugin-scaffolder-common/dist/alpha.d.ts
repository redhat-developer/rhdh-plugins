 ...
 * @alpha
 */
declare const RESOURCE_TYPE_SCAFFOLDER_TASK = "scaffolder-task";
/**
 ...
 * @alpha
 */
declare const taskReadPermission: _backstage_plugin_permission_common.ResourcePermission<"scaffolder-task">;
/**
 ...
 * @alpha
 */
declare const taskCancelPermission: _backstage_plugin_permission_common.ResourcePermission<"scaffolder-task">;
/**
 ...
 * @alpha
 */
declare const scaffolderTaskPermissions: (_backstage_plugin_permission_common.BasicPermission | _backstage_plugin_permission_common.ResourcePermission<"scaffolder-task">)[];
/**
