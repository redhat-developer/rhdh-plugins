 ...
 * ServicePort contains information on service's port.
 */
export declare class ServicePort extends Model<IServicePort> implements IServicePort {
    "appProtocol"?: string;
    "name"?: string;
    "nodePort"?: number;
    "port": number;
...
export { IServicePort as IIoK8sApiCoreV1ServicePort, ServicePort as IoK8sApiCoreV1ServicePort };
