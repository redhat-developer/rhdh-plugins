 ...
 * DownwardAPIVolumeFile represents information to create the file containing the pod field
 */
export declare class DownwardAPIVolumeFile extends Model<IDownwardAPIVolumeFile> implements IDownwardAPIVolumeFile {
    "fieldRef"?: IIoK8sApiCoreV1ObjectFieldSelector;
    "mode"?: number;
    "path": string;
    "resourceFieldRef"?: IIoK8sApiCoreV1ResourceFieldSelector;
}
export { IDownwardAPIVolumeFile as IIoK8sApiCoreV1DownwardAPIVolumeFile, DownwardAPIVolumeFile as IoK8sApiCoreV1DownwardAPIVolumeFile };
