import { IIoK8sApiCoreV1Capabilities } from "./Capabilities";
 ...
 * SecurityContext holds security configuration that will be applied to a container. Some fields are present in both SecurityContext and PodSecurityContext.  When both are set, the values in SecurityContext take precedence.
 */
export declare class SecurityContext extends Model<ISecurityContext> implements ISecurityContext {
    "allowPrivilegeEscalation"?: boolean;
    "capabilities"?: IIoK8sApiCoreV1Capabilities;
    "privileged"?: boolean;
    "procMount"?: "Default" | "Unmasked";
...
export { ISecurityContext as IIoK8sApiCoreV1SecurityContext, SecurityContext as IoK8sApiCoreV1SecurityContext };
