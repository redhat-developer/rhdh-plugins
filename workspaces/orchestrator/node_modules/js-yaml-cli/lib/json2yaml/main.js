(function() {
  var doTheWork, exitCodes, fs, path, util, yaml;
  ...
  doTheWork = function(modArgs, cb) {
    ...
    return fs.readFile(srcFile, {
      ...
      var isYaml, output, resultString;
      if (error) {
      ...
      if (isYaml) {
        ...
        return cb(exitCodes.OK);
      } else {
        return console.log(yaml.dump(output));
      }
    });
  };
