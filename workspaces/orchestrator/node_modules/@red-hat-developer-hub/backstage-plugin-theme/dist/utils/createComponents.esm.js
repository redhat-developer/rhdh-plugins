import { defaultComponentThemes } from '@backstage/theme';
import { redHatFontFaces, redHatFonts } from '../fonts.esm.js';

const createComponents = (themeConfig) => {
  const options = themeConfig.options ?? {};
  const disableRipple = options?.rippleEffect !== "on";
  const palette = themeConfig.palette ?? {};
  const general = palette.rhdh?.general || {};
  const rhdhPrimary = palette.rhdh?.primary || {};
  const rhdhSecondary = palette.rhdh?.secondary || {};
  const components = {};
  ...
  components.MuiCssBaseline = {
    styleOverrides: (theme) => {
      const backstageOverrides = defaultComponentThemes.MuiCssBaseline.styleOverrides;
      const backstageStyles = typeof backstageOverrides === "function" ? backstageOverrides(theme) : backstageOverrides;
      return {
        ...backstageStyles,
        "@font-face": redHatFontFaces,
        body: {
          ...backstageStyles.body,
...
//# sourceMappingURL=createComponents.esm.js.map
