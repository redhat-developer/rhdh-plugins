...
var Keyv = class extends event_manager_default {
  ...
  async deleteMany(keys) {
    try {
      ...
      this.hooks.trigger("postDelete", { key: keyPrefixed, value: returnResult });
      return returnResult;
    } catch (error) {
      this.emit("error", error);
      return false;
...
// src/index.ts
var KeyvValkey = class extends EventEmitter {
  ttlSupport = true;
  namespace;
  opts;
  redis;
...
function createKeyv(connect, options) {
  ...
  const keyv = new index_default(adapter);
  return keyv;
}
var index_default2 = KeyvValkey;
export {
  createKeyv,
