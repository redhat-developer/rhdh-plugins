...
function createWatchCompilerHost(parsedConfig, createProgram, reportDiagnostic, reportWatchStatus, afterProgramCreate) {
    ...
    return {
        ...
        watchFile: system_1.system.watchFile,
        watchDirectory: system_1.system.watchDirectory,
        setTimeout: system_1.system.setTimeout,
        clearTimeout: system_1.system.clearTimeout,
        fileExists: system_1.system.fileExists,
        readFile: system_1.system.readFile,
        directoryExists: system_1.system.directoryExists,
        getDirectories: system_1.system.getDirectories,
        realpath: system_1.system.realpath,
    };
}
