import { l as Extensions, q as PGliteOptions, x as BasePGlite, d as PGliteInterface, r as PGliteInterfaceExtensions, D as DebugLevel, n as ExecProtocolResult, B as BackendMessage, T as Transaction, y as DumpTarCompressionOptions, b as PGlite } from '../pglite-CntadC_p.cjs';
...
declare class PGliteWorker extends BasePGlite implements PGliteInterface, AsyncDisposable {
     ...
     * @returns The result of the query
     */
    execProtocolStream(message: Uint8Array): Promise<BackendMessage[]>;
    /**
