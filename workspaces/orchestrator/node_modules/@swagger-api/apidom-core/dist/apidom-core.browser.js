...
/* harmony import */ var _errors_ElementIdentityError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2802);
...
class IdentityManager {
  ...
  identify(element) {
    if (!(0,_predicates__WEBPACK_IMPORTED_MODULE_2__.isElement)(element)) {
      throw new _errors_ElementIdentityError__WEBPACK_IMPORTED_MODULE_3__["default"]('Cannot not identify the element. `element` is neither structurally compatible nor a subclass of an Element class.', {
        value: element
      });
    }

    // use already assigned identity
    if (element.meta.hasKey('id') && (0,_predicates__WEBPACK_IMPORTED_MODULE_2__.isStringElement)(element.meta.get('id')) && !element.meta.get('id').equals('')) {
      return element.id;
    }
...
const plugin = ({
  ...
  return {
    pre() {
      identityManager = new _identity__WEBPACK_IMPORTED_MODULE_0__.IdentityManager({
        length
      });
    },
    visitor: {
