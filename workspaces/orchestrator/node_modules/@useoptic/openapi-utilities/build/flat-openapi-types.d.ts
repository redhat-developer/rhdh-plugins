...
export declare namespace FlatOpenAPI {
    type Document<T extends {} = {}> = FlatOpenAPIV2.Document<T> | FlatOpenAPIV3.Document<T> | FlatOpenAPIV3_1.Document<T>;
    type Operation<T extends {} = {}> = FlatOpenAPIV2.OperationObject<T> | FlatOpenAPIV3.OperationObject<T> | FlatOpenAPIV3_1.OperationObject<T>;
    type Parameter = FlatOpenAPIV3_1.ParameterObject | FlatOpenAPIV3.ParameterObject | FlatOpenAPIV2.Parameter;
    type Parameters = FlatOpenAPIV3_1.ParameterObject[] | FlatOpenAPIV3.ParameterObject[] | FlatOpenAPIV2.Parameter[];
    interface Request {
        body?: any;
        headers?: object;
        params?: object;
...
export declare namespace FlatOpenAPIV3_1 {
    ...
    export type Document<T extends {} = {}> = Modify<Omit<FlatOpenAPIV3.Document<T>, 'paths' | 'components'>, {
        info: InfoObject;
    ...
    export type InfoObject = Modify<FlatOpenAPIV3.InfoObject, {
        summary?: string;
        license?: LicenseObject;
    }>;
    export type ContactObject = FlatOpenAPIV3.ContactObject;
    export type LicenseObject = Modify<FlatOpenAPIV3.LicenseObject, {
        identifier?: string;
    }>;
    export type ServerObject = Modify<FlatOpenAPIV3.ServerObject, {
        url: string;
        description?: string;
        variables?: Record<string, ServerVariableObject>;
    }>;
    export type ServerVariableObject = Modify<FlatOpenAPIV3.ServerVariableObject, {
        enum?: [string, ...string[]];
    }>;
    export type PathsObject<T extends {} = {}, P extends {} = {}> = Record<string, (PathItemObject<T> & P) | undefined>;
    export type PathItemObject<T extends {} = {}> = Modify<FlatOpenAPIV3.PathItemObject<T>, {
        servers?: ServerObject[];
        parameters?: ParameterObject[];
    }> & {
        [method in HttpMethods]?: OperationObject<T>;
    };
    export type OperationObject<T extends {} = {}> = Modify<FlatOpenAPIV3.OperationObject<T>, {
        parameters?: ParameterObject[];
    ...
    export type ExternalDocumentationObject = FlatOpenAPIV3.ExternalDocumentationObject;
    ...
    export type NonArraySchemaObjectType = FlatOpenAPIV3.NonArraySchemaObjectType | 'null';
    ...
    export type BaseSchemaObject = Modify<Omit<FlatOpenAPIV3.BaseSchemaObject, 'nullable'>, {
    ...
    export type MediaTypeObject = Modify<FlatOpenAPIV3.MediaTypeObject, {
        schema?: SchemaObject;
        examples?: Record<string, ExampleObject>;
    }>;
    export type EncodingObject = FlatOpenAPIV3.EncodingObject;
    export type RequestBodyObject = Modify<FlatOpenAPIV3.RequestBodyObject, {
        content: {
            [media: string]: MediaTypeObject;
        };
    }>;
    export type ResponsesObject = Record<string, ResponseObject>;
    export type ResponseObject = Modify<FlatOpenAPIV3.ResponseObject, {
        headers?: {
    ...
    export type LinkObject = Modify<FlatOpenAPIV3.LinkObject, {
        server?: ServerObject;
    }>;
    export type CallbackObject = Record<string, PathItemObject>;
    export type SecurityRequirementObject = FlatOpenAPIV3.SecurityRequirementObject;
    export type ComponentsObject = Modify<FlatOpenAPIV3.ComponentsObject, {
...
export declare namespace FlatOpenAPIV3 {
...
export declare namespace FlatOpenAPIV2 {
    interface Document<T extends {} = {}> {
        basePath?: string;
        consumes?: MimeTypes;
...
//# sourceMappingURL=flat-openapi-types.d.ts.map