...
// Based on https://github.com/backstage/backstage/blob/v1.54.6/plugins/catalog/src/alpha/components/EntityHeader/EntityHeaderBui.tsx
...
/**
 * `EntityHeaderBui` copy from `@backstage/plugin-catalog`, because its not exported.
 * @alpha
 */
