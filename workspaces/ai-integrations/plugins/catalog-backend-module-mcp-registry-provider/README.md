...
| `defaultLifecycle` | No       | `production` (mapping default)   | Value used as `spec.lifecycle`                                                                                                                                                                                                                                                                                                                                                                  |
